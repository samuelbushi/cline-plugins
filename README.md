...
| `amplitude` | Amplitude MCP access and product analytics skills for charts, dashboards, experiments, feedback, replays, taxonomy, AI visibility, and instrumentation. |
