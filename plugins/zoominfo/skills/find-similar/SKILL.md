...
- Suggest next steps: use `zoominfo-enrich-company` to get full details on any result, or `zoominfo-buying-committee` to identify contacts at a target.
...
- Suggest next steps: use `zoominfo-enrich-contact` to get full details on any result, or `zoominfo-buying-committee` to identify other contacts at a specific company from the list.
