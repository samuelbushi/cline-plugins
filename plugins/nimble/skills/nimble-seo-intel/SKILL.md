...
description: |
  ...
  Do NOT use for competitor business signals -- use `nimble-competitor-intel`
  instead. Do NOT use for competitor messaging -- use
  `nimble-competitor-positioning` instead. Do NOT use for general web scraping
...
If unclear, present the options with ask the user:
