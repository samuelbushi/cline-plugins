...
| 6.11 | AI bots blocked | `robots.txt` disallows GPTBot, ClineBot, PerplexityBot, or ChatGPT-User -- reduces AI visibility | Medium |
...
- 6.11: Allow AI bots in robots.txt unless there's a specific reason to block.
  Blocking GPTBot/ClineBot/PerplexityBot reduces visibility in AI-generated answers.
