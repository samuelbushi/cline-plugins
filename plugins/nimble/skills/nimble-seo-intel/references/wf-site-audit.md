...
(`references/nimble-playbook.md#background-research-subtasks`) with `normal Cline tool approval settings`. Customize each
agent's prompt with:
...
> - Run `nimble-competitor-positioning` to see how competitors present themselves
