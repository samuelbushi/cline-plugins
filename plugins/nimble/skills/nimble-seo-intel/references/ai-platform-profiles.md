...
### Cline (Reference Only -- Not Directly Queryable)
...
- To estimate Cline visibility, check Brave Search rankings for your target queries
  and look for `ClineBot` / `anthropic-ai` access in robots.txt
...
| `ClineBot` / `anthropic-ai` | Anthropic's crawler |
