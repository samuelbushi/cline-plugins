...
Compares a user's existing business list against nimble-market-finder's discovery results,
...
| `discovered_only` | Found by nimble-market-finder but NOT in reference list | Expansion candidates -- potential gaps in your list |
| `reference_only` | In reference list but NOT found by nimble-market-finder | Coverage gaps -- these may have closed, moved, or been missed by discovery |
...
## TL;DR
[M/R x 100]% coverage -- [M] of [R] reference entries verified, [DO] new businesses
...
## Coverage Score
[M/R x 100]% of your reference list was independently verified by market discovery.
...
## Discovered Only ([DO]) -- Expansion Candidates
Found by nimble-market-finder but missing from your reference list.
...
- "Run nimble-company-deep-dive on new discoveries?" -- deep research on high-strength
