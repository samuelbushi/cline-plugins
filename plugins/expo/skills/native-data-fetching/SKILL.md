...
description: Use when implementing or debugging networking, API calls, or data fetching in Expo or React Native apps. Covers fetch API, React Query, SWR, error handling, caching, offline support, and Expo Router data loaders (`useLoaderData`).
version: 1.0.0
license: MIT
---
...
Use this skill for Expo or React Native networking work, including API requests, data fetching, caching, or network debugging.
...
- Implementing API requests in an Expo or React Native app
- Setting up data fetching (React Query, SWR) for mobile or Expo web
- Using Expo Router data loaders (`useLoaderData`, web SDK 55+)
- Debugging network failures in an Expo or React Native runtime
- Implementing caching strategies for mobile constraints
- Handling offline scenarios
- Authentication/token management in app code
- Configuring API URLs and environment variables for Expo
