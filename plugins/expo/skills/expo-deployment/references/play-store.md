...
```bash
# Use the Expo dashboard or an interactive EAS CLI prompt.
# Do not pass service account JSON as a shell argument.
eas secret:create --name GOOGLE_SERVICE_ACCOUNT --type file
```
