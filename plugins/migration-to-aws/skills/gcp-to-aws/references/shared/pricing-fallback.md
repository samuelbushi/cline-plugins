...
> `pricing-cache.md` (primary) and an optional user-managed AWS Pricing MCP server (secondary) are unavailable.
...
2. No user-managed pricing MCP is configured, or the live pricing call fails or times out
