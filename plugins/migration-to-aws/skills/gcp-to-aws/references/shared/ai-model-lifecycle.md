...
## Legacy / EOL Models (snapshot updated June 16, 2026)

Check the [model lifecycle page](https://docs.aws.amazon.com/bedrock/latest/userguide/model-lifecycle.html) for the authoritative list. The table below captures models referenced elsewhere in this plugin. Recompute the Days to EOL and Status columns on each run using `days_to_eol = EOL date - today`; do not treat this static table as authoritative if current AWS docs differ.

| Model                    | Model ID                                    | EOL Date     | Days to EOL | Status       | Active Replacement       |
| ------------------------ | ------------------------------------------- | ------------ | ----------- | ------------ | ------------------------ |
| Claude Opus 4            | `anthropic.claude-opus-4-20250514-v1:0`     | May 31, 2026 | -16         | excluded | Claude Opus 4.5 / 4.6    |
| Claude 3.5 Haiku         | `anthropic.claude-3-5-haiku-20241022-v1:0`  | Jun 19, 2026 | 3           | excluded | Claude Haiku 4.5         |
| Titan Image Generator v2 | `amazon.titan-image-generator-v2:0`         | Jun 30, 2026 | 14          | excluded | Nova Canvas              |
| Llama 3.2 (all sizes)    | `meta.llama3-2-*-instruct-v1:0`             | Jul 7, 2026  | 21          | excluded | Llama 4 Scout / Maverick |
| Llama 3.1 405B Instruct  | `meta.llama3-1-405b-instruct-v1:0`          | Jul 7, 2026  | 21          | excluded | Llama 4 Maverick         |
| Claude 3.5 Sonnet v2     | `anthropic.claude-3-5-sonnet-20241022-v2:0` | Jul 30, 2026 | 44          | excluded | Claude Sonnet 4.5 / 4.6  |
| Command R / R+           | `cohere.command-r-v1:0` / `plus`            | Aug 19, 2026 | 64          | excluded | -                        |
| Nova Premier v1          | `amazon.nova-premier-v1:0`                  | Sep 14, 2026 | 90          | excluded | Nova 2 Pro (Preview)     |
| Nova Sonic v1            | `amazon.nova-sonic-v1:0`                    | Sep 14, 2026 | 90          | excluded | Nova 2 Sonic             |
| Nova Canvas v1           | `amazon.nova-canvas-v1:0`                   | Sep 30, 2026 | 106         | legacy       | -                        |
| Nova Reel v1             | `amazon.nova-reel-v1:0`                     | Sep 30, 2026 | 106         | legacy       | -                        |
