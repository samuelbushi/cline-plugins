...
Verify all pricing and model availability before making a final recommendation. Use a user-managed pricing MCP when available, otherwise use `references/shared/pricing-cache.md` with a staleness warning.
