...
```bash
# Fetch recent errors with a bounded result set
npx base44 logs --level error --since 2024-01-15T10:00:00 --limit 10

# Fetch recent errors for a specific function
npx base44 logs --function my-function --level error --since 2024-01-15T10:00:00 --limit 10

# Fetch recent logs for multiple functions
npx base44 logs --function send-email,process-payment --since 2024-01-15T10:00:00 --limit 10

# Fetch logs since a specific time
npx base44 logs --function my-function --since 2024-01-15T10:00:00 --limit 10

# Fetch logs within a time range
npx base44 logs --function my-function --since 2024-01-15T10:00:00 --until 2024-01-15T12:00:00 --limit 10

# Fetch a bounded set in ascending order
npx base44 logs --function my-function --since 2024-01-15T10:00:00 --limit 10 --order asc
