---
name: base44-sdk
description: Use this skill when implementing JavaScript or TypeScript features in an existing Base44 app with @base44/sdk, including auth, entities, functions, connectors, storage, app logs, analytics, and service-role boundaries.
---
...
- WRONG Initializing new Base44 projects (use `base44-cli` instead)
- WRONG Empty directories without Base44 configuration
- WRONG When user says "create a new Base44 project/app/site" and no project exists
- WRONG CLI commands like `npx base44 create`, `npx base44 deploy`, `npx base44 login` (use `base44-cli`)
...
Before writing Base44 code, verify method names against this table or [QUICK_REFERENCE.md](references/QUICK_REFERENCE.md).
