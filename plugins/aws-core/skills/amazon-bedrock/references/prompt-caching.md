...
### 2. Confirm Current Implementation Guidance

Use this bundled reference first. If the user needs the latest implementation examples, use sanitized AWS documentation or `aws-mcp` documentation lookup when available; ask before fetching external URLs or sending private project context.
