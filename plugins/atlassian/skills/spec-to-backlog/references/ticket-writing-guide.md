...
[OK] "Implement user registration API endpoint"
[OK] "Fix pagination bug in search results"
[OK] "Add email validation to signup form"
[OK] "Optimize database query for dashboard load time"
[OK] "Create documentation for payment webhook"
[OK] "Design user preferences data schema"

### Bad Examples

[NO] "Users" - Not actionable
[NO] "Do backend work" - Too vague
[NO] "Fix bug" - Lacks specificity
[NO] "API" - Not a task
[NO] "There's an issue with the login page that needs to be addressed" - Too wordy
...
[OK] "User can submit form and receive confirmation email within 30 seconds"
[OK] "API returns 400 error when email field is empty"
[OK] "Dashboard loads in under 2 seconds on 3G connection"
[OK] "All text meets WCAG 2.1 AA contrast ratios"

### Bad Acceptance Criteria

[NO] "Feature works well" - Not specific
[NO] "Code is clean" - Subjective, not testable
[NO] "Fast performance" - Not measurable
[NO] "No bugs" - Too broad
...
[NO] Pages of requirements copied from spec doc
[OK] Summary with link to full spec

### 2. Assuming Context
[NO] "Fix the bug we discussed"
[OK] Clear description of the bug with reproduction steps

### 3. Implementation as Requirement
[NO] "Use React hooks for state management"
[OK] "Component updates in real-time" (let developer choose approach unless there's a specific reason)

### 4. Vague Acceptance Criteria
[NO] "Everything works correctly"
[OK] Specific, testable outcomes

### 5. Missing Links
[NO] No reference to designs, specs, or related work
[OK] Links to all relevant documentation
