...
[NO] Too brief: "Build notifications" - lacks context
[NO] Too detailed: Including implementation details that belong in tickets
[NO] No success criteria: How do we know when it's done?
[NO] Missing source link: Hard to trace back to requirements
[NO] Vague scope: Leads to scope creep and confusion
