...
"[OK] Created Epic: PROJ-123 - User Authentication System"
...
- [OK] "Design authentication database schema"
- [OK] "Build login form UI components"
- [NO] "Do backend work" (too vague)
- [NO] "Frontend" (not actionable)
...
- [OK] "API returns 201 status on successful user creation"
- [OK] "Password must be at least 8 characters and hashed with bcrypt"
- [OK] "Login form validates email format before submission"
- [NO] "User can log in" (too vague)
- [NO] "It works correctly" (not testable)
...
```
[OK] Backlog created successfully!
...
### Be Specific
- [NO] "Do frontend work"
- [OK] "Create login form UI with email/password inputs and validation"
...
- `references/breakdown-examples.md` - additional examples for turning specs into epics and child tickets.
- `references/epic-templates.md` - reusable Epic structures for common backlog types.
- `references/ticket-writing-guide.md` - guidance for writing implementation tickets with useful summaries, descriptions, and acceptance criteria.
