...
Do:
- [OK] Use specific technical terms: "OAuth authentication flow"
- [OK] Include system names: "Stratus minions"
- [OK] Use acronyms if they're common: "API rate limiting"
- [OK] Try variations if first search fails: "deploy process" -> "deployment pipeline"

Don't:
- [NO] Be too generic: "how things work"
- [NO] Use full sentences: Use key terms instead
- [NO] Include filler words: "the", "our", "about"
...
### Do:
[OK] Always search before answering (don't rely on general knowledge)
[OK] Cite all sources with links
[OK] Note discrepancies explicitly
[OK] Mention when information is old
[OK] Provide context and examples
[OK] Structure answers clearly with headers
[OK] Link to related documentation

### Don't:
[NO] Assume general knowledge applies to this company
[NO] Make up information if search returns nothing
[NO] Ignore conflicting information
[NO] Quote entire documents (summarize instead)
[NO] Overwhelm with too many sources (curate top 5-10)
[NO] Forget to fetch details when snippets are insufficient
...
[NO] General technology questions (use your training knowledge)
[NO] External documentation (use web_search)
[NO] Company-agnostic questions
[NO] Questions about other companies
