...
```
[OK] @john to update tests
[OK] Sarah will write docs
[OK] Mike: review code
[OK] TODO: Deploy (Lisa)
[OK] Action: John - fix bug

[WARN] Maybe John can help?
[WARN] Documentation needs work
[WARN] We should test this

[NO] John mentioned testing
[NO] Tests were updated
[NO] Someone needs to deploy
```
