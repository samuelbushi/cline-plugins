...
[WARN] This appears to be a regression of [PROJ-XXX], which was resolved on [date].
...
[OK] Use structured format with headers
[OK] Include complete error messages in code blocks
[OK] Provide context (environment, version, time)
[OK] List concrete steps to reproduce
[OK] Quantify impact (affected users, frequency)
[OK] Add relevant logs in code blocks
[OK] Reference related issues with links

### What to Avoid

[NO] Pasting entire stack traces without context
[NO] Vague descriptions like "it doesn't work"
[NO] Missing environment information
[NO] No reproduction steps
[NO] Formatting errors/code without code blocks
[NO] Forgetting to mention user impact
