...
[NO] Searching with full stack traces (too specific, no matches)
[NO] Using only exact text matching (miss paraphrased duplicates)
[NO] Ignoring resolved issues (miss regressions)
[NO] Not checking multiple projects (duplicate across teams)
[NO] Only searching summaries (miss details in descriptions)
