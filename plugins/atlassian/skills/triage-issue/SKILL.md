...
Use key terms only:
- [OK] "timeout login mobile"
- [OK] "NullPointerException PaymentProcessor refund"
- [NO] "Users are getting a connection timeout error when..." (too verbose)
...
```
[SEARCH] Triage Results: Likely Duplicate
...
```
[SEARCH] Triage Results: Possibly Related Issues Found
...
```
[SEARCH] Triage Results: No Duplicates Found
...
Examples:
- [OK] "Mobile Login: Connection timeout during authentication"
- [OK] "Payment API: NullPointerException in refund processing"
- [OK] "Dashboard: Infinite loading on reports page"
- [NO] "Error in production" (too vague)
- [NO] "Users experiencing issues" (not specific)
...
```
[SEARCH] Triage Results: Multiple Possible Duplicates
...
```
[SEARCH] Triage Results: Possible Regression
...
Do:
[OK] Use multiple search queries with different angles
[OK] Include both open and resolved issues in search
[OK] Search for error signatures and symptoms separately
[OK] Look at recent issues first (last 30-90 days)
[OK] Check for patterns (multiple reports of same thing)

Don't:
[NO] Search with entire error messages (too specific)
[NO] Only search open issues (miss fix history)
[NO] Ignore resolved issues (miss regressions)
[NO] Use too many keywords (reduces matches)

### For Issue Creation:

Do:
[OK] Write clear, specific summaries with component names
[OK] Include complete error messages in code blocks
[OK] Add environment and impact details
[OK] Reference related issues found during search
[OK] Use "Bug" issue type for actual bugs

Don't:
[NO] Create vague summaries like "Error in production"
[NO] Paste entire stack traces in summary (use description)
[NO] Skip reproduction steps
[NO] Forget to mention user impact
[NO] Hard-code issue type without checking availability
...
Output:
```
[OK] New Issue Created (Possible Regression)
...
[NO] Feature requests (use spec-to-backlog)
[NO] General task creation (use capture-tasks-from-meeting-notes)
[NO] Searching for information (use search-company-knowledge)
[NO] Generating status reports (use generate-status-report)

Use this skill specifically for:
[OK] "Is this a duplicate bug?"
[OK] "Triage this error message"
[OK] "Has this been reported before?"
[OK] "Create a bug ticket for this"
...
- `references/bug-report-templates.md` - reusable bug report structures for different severity and evidence levels.
- `references/search-patterns.md` - JQL and keyword search patterns for finding duplicate or related issues.
