...
> _"After completing the work, return a clickable link via the `airtable-link` skill. Hand off the most-specific URL the agent's tool calls have proven access to."_
