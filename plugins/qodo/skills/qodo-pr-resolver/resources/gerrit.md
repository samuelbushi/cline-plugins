...
- Fixed: `DONE Fixed - <brief description>` - set `"unresolved": false`
- Deferred: `DEFER Deferred - <reason>` - set `"unresolved": false`
...
Summary format: same as [providers.md section Summary format](./providers.md#post-summary-comment).
...
```
Link: Change: https://<gerrit-host>/c/<project>/+/<change-number>
```
