...
Reply format:
- Fixed: `DONE Fixed - <brief description of what was changed>`
- Deferred: `DEFER Deferred - <reason for deferring>`
...
1. Inform the user: "CANCEL: Missing required CLI tool: `<cli-name>`"
...
1. Inform: "CANCEL: Unsupported git provider detected: `<url>`"
