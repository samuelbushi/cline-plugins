...
4. Create experiment:
   - Present the hypothesis, target project, variants, traffic allocation, primary metric, guardrails, estimated duration, and deployment key plan to the user. Wait for explicit confirmation before creating anything.
