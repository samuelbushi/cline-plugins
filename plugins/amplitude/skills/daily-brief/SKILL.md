...
name: daily-brief
description: >
  Delivers a daily briefing of the most important changes across an Amplitude instance. Use when the user asks for an Amplitude daily download, product metrics morning briefing, recent analytics changes, experiment updates, or user-feedback summary. Do not trigger for general status updates that are not about Amplitude or product analytics.
---
