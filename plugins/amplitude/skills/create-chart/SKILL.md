...
9. Present the exact chart name, project, event definition, filters, breakdowns, visualization type, and expected saved location to the user. Wait for explicit confirmation before saving.
