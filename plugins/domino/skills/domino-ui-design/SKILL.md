...
Domino Logo: Reference `assets/domino-logo.svg` from this skill's directory. The SVG is white text on transparent background, designed for the dark nav bar.
