...
license: MIT
compatibility: Works with Cline and other MCP-capable AI coding tools.
metadata:
...
Add to your MCP client configuration. For Cline, use the MCP wizard or user MCP settings and choose either the local Streamable HTTP endpoint or a stdio command that launches the server.
