...
license: MIT
compatibility: Requires rover CLI installed. Works with Cline and other AI coding assistants.
metadata:
...
- Consider entity relationships when ID fields point at separately resolvable graph entities
