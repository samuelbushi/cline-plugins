...
### [yes] When to pass by value, `Copy`:
...
### [yes] Good struct to derive `Copy`:
```rust
...
### [yes] Cases to use each pattern matching for Option and Return
...
### [no] Bad Option/Return pattern matching:
...
### [yes] Breaking up long functions over commenting them
