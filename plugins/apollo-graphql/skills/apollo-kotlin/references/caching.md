...
- To determine the latest version, execute `../scripts/list-apollo-kotlin-normalized-cache-versions.sh` from this reference directory and pick the latest release
