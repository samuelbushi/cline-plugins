...
Carta adds one Carta MCP connection plus Cline skills for cap table workflows, Carta CRM, investor reporting, budgeting, compensation benchmarks, equity scenarios, and safe handling of sensitive financial data.
...
- `skills`: seven workflow skills cover auth and discovery, cap table reporting, equity scenarios, compensation benchmarks, CRM operations, investor reporting, and investor budgeting.
