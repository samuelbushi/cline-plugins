...
Operations supported:
    ...
    conditional_format          -- add CellIsRule font/fill rules to a range
    ...
    for op in payload.get("operations", []):
        ...
        if kind == "create_sheet":
            ...
            for rule in op.get("rules", []):
                ...
                if font_color:
                    kwargs["font"] = Font(color=font_color.lstrip("#"))
                if fill_color:
