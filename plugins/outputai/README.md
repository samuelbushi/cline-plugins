...
Installs a focused workbench for Output SDK projects. The skills help Cline plan durable LLM workflows, implement them with Output SDK conventions, debug local runs and traces, manage encrypted credentials safely, design evaluation datasets and judges, and review common SDK patterns.
...
Cline uses the bundled Output.ai skills to gather requirements, design steps and schemas, plan prompts and evaluators, and keep implementation work aligned with Output SDK conventions.
