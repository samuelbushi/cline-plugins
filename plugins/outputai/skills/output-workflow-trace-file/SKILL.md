...
Input - Either a workflow name (e.g. `context_competitors`) or a workflow run ID from the user's request. If empty, use the most recent trace across all workflows.
