...
Ask for explicit approval before executing a workflow. Workflow runs may call LLMs, APIs, databases, or other services and may expose sensitive input/output in terminal logs.
