...
- `src/workflows/my_workflow/evaluators.ts` OK
- `src/workflows/my_workflow/evaluators/quality.ts` OK
- `src/shared/evaluators/common_evaluators.ts` OK
- `src/workflows/my_workflow/helpers.ts` X (cannot contain evaluator() calls)
...
import { otherEvaluator } from '../../shared/evaluators/other.js'; // X
import { anotherEvaluator } from './other_evaluators.js'; // X
```
