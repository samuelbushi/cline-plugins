...
Ask for explicit approval before resetting a workflow. Reset terminates the current run and creates a new run that reuses recorded outputs before the selected step.
