...
Ask for explicit approval before starting a workflow. Async workflows can continue running after the command returns and may call LLMs, APIs, databases, or other services.
