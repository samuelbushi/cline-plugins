...
Ask for explicit approval before running credential CLI commands. `show` and `get` print plaintext secrets; keep outputs out of chat unless the user explicitly requests a specific value.
