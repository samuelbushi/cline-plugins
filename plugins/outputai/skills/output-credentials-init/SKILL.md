...
Ask for explicit approval before initializing or overwriting credentials. Verify `.key` files are ignored before creating new credential stores, and never paste generated key material into chat.
