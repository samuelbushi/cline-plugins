...
- `src/workflows/my_workflow/steps.ts` OK
- `src/workflows/my_workflow/steps/fetch_data.ts` OK
- `src/shared/steps/common_steps.ts` OK
- `src/workflows/my_workflow/helpers.ts` X (cannot contain step() calls)
...
import { otherStep } from '../../shared/steps/other.js'; // X
import { anotherStep } from './other_steps.js'; // X
```
