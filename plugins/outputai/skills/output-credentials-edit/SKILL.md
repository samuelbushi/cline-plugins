...
Ask for explicit approval before running any credential command. `show` and `get` print plaintext secrets; do not paste returned secret values into chat unless the user specifically asks for that value.
