...
Prefer local examples first. Ask before cloning, downloading, or running third-party plugin code.

```bash
# Optional after user approval: clone official plugins for reference
git clone https://github.com/voxel51/fiftyone-plugins.git /tmp/fiftyone-plugins
