...
Ask for explicit approval before downloading or enabling the evaluation plugin; this mutates the user's FiftyOne plugin directory and pulls executable plugin code.
...
Ask for approval before downloading or enabling it.
...
- Ask for approval, then install the evaluation plugin:
  ```python
  download_plugin(url_or_repo="voxel51/fiftyone-plugins", plugin_names=["@voxel51/evaluation"])
  enable_plugin(plugin_name="@voxel51/evaluation")
  ```
