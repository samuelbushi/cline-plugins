...
5. Last cell should describe optional cleanup. Do not delete datasets by default; only include commented cleanup for scratch zoo datasets created by the notebook.
...
| N+1 | markdown/code | Optional cleanup instructions. Leave `fo.delete_dataset("dataset-name")` commented out and label it for scratch tutorial datasets only. |
