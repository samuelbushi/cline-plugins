...
### Cell 20 -- code
```python
# Optional cleanup for this scratch tutorial dataset only:
...
| 18 | code | Optional cleanup, commented out: `# fo.delete_dataset("classification-getting-started")` |
...
| 14 | code | Optional cleanup, commented out: `# fo.delete_dataset("similarity-getting-started")` |
