...
Mitigation is the same as for all cold-start latency: reuse sessions, keep the image lean, defer heavy initialization. See `aws-agents-harden` Initialization time section.
