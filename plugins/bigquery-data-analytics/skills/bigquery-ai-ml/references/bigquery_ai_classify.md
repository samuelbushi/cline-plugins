...
| :--- | :--- | :--- | :--- |
| Single Label | `NULL` (Default) | `STRING` | The single category that best fits the input. |
| Single Label (Explicit) | `'single'` | `ARRAY<STRING>` | An array containing exactly one category string. |
| Multi Label | `'multi'` | `ARRAY<STRING>` | An array containing zero or more matching categories. |
