...
Key boundary: Search answers ad-hoc questions ("who owns X?"). Quality handles systematic reports ("what percentage of tables lack owners?") and health or assertion work.
...
- "Want a full quality report? Use `/datahub-quality`"
...
- User asks for a systematic report ("how complete is our metadata", "generate a quality report") -> use `/datahub-quality`.
