...
| ----------------- | --------------- | -------------------------------------------------- |
| `corpUserInfo`    | PASS ALWAYS       | User profile info (name, email, title, department) |
| `corpGroupInfo`   | PASS ALWAYS       | Group info (name, description, email)              |
| `groupMembership` | PASS IF AVAILABLE | User's group memberships                           |
