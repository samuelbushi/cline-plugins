...
1. Parse + infer - apply `DISCOVERY-connect.md` §§ 1–2: read the brought-in site (markup, copy, tokens; opportunistically any design-handoff bundle), infer the domain → Wix capability (the universal floor is a Wix Forms contact/lead form), and infer the brand.
