...
For deeper Gradio API guidance - components, layouts, event listeners, chatbots, the Gradio 5 to 6 migration - use the bundled `huggingface-gradio` skill.
