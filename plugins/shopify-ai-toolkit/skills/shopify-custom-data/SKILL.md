...
Docs: [Metafields & Metaobjects](https://shopify.dev/docs/apps/build-files/custom-data)
</critical-instructions>

### Always use Shopify CLI

- CLI: ALWAYS use Shopify CLI to scaffold apps and extensions. Never hand-roll files: `shopify app init`, `shopify app generate extension`, `shopify app dev`.
- Do not run `shopify app deploy` unless the user explicitly confirms they want to deploy.
