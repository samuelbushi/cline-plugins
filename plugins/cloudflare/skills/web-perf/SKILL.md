...
Ask the user to install or enable Cline's Chrome DevTools MCP plugin, or otherwise connect the Chrome DevTools MCP server in their MCP settings, before running the audit.
