...
- `aws-dev-security-review` -- comprehensive security audit and IaC review
- `aws-dev-architect` -- well-architected design guidance
- `aws-dev-networking` -- VPC, subnets, security groups, NACLs
- `aws-dev-lambda` -- Lambda execution roles and resource policies
- `aws-dev-ecs` -- ECS task roles vs task execution roles
- `aws-dev-eks` -- Kubernetes RBAC and IRSA (IAM Roles for Service Accounts)
