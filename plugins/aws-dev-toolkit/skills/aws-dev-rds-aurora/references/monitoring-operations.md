...
Resource creation and modification belong in IaC (CDK, CloudFormation, Terraform). Use the `aws-dev-iac-scaffold` skill for templates. The CLI commands below are for diagnostics, investigation, and operational procedures only.
