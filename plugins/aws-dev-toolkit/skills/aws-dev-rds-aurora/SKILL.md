...
2. Use the `awsknowledge` MCP tools to verify current RDS/Aurora limits, engine versions, and features
...
- `aws-dev-cost-check` - Detailed cost analysis and Reserved Instance recommendations
- `aws-dev-security-review` - IAM, network, and encryption audit for database configurations
- `aws-dev-networking` - VPC design, subnet planning, and security group configuration
