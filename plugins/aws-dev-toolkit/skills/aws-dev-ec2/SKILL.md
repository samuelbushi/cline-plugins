...
5. Use the `awsknowledge` MCP tools to verify current instance types, pricing, or feature availability
...
- `aws-dev-networking` - VPC, subnets, security groups, and NAT strategy for EC2 instances
- `aws-dev-iam` - Instance profiles, least-privilege policies, and SSM permissions
- `aws-dev-s3` - Storage integration, instance backups, and bootstrap scripts
- `aws-dev-observability` - CloudWatch agent, alarms, dashboards, and Compute Optimizer
- `aws-dev-cloudfront` - CDN in front of EC2-backed web applications
