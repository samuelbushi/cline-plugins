...
1. Determine the source:
   - If the user asks for a diagram from IaC, scan the repo for IaC files (CDK, Terraform, CloudFormation, SAM) and reverse-engineer the architecture
   - Otherwise, use the user's description or conversation context
