...
- `aws-dev-lambda` -- Backend integration functions, authorizer implementation
- `aws-dev-iam` -- IAM policies for API Gateway access, SigV4 authorization
- `aws-dev-cloudfront` -- CDN caching in front of API Gateway, custom domain routing
- `aws-dev-networking` -- VPC links, private API configuration, DNS
- `aws-dev-security-review` -- Review API Gateway security posture, authorizer configuration, and WAF rules
