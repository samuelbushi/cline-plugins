...
- `aws-dev-s3` - S3 origins, bucket policies, and Origin Access Control
- `aws-dev-api-gateway` - API Gateway origins, regional endpoints, and cache behavior config
- `aws-dev-lambda` - Lambda@Edge functions and CloudFront Function alternatives
- `aws-dev-networking` - ALB origins, VPC connectivity, and DNS with Route53
- `aws-dev-security-review` - WAF rules, signed URLs, and public exposure review
