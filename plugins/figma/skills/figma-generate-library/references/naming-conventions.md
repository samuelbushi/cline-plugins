...
Key distinction: The casing rule applies to *Figma variable names*. Code syntax names follow *platform conventions* regardless of the Figma name case -- see section9 for the full picture.
