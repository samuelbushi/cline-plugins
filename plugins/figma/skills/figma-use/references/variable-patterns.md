...
Always set scopes explicitly -- `ALL_SCOPES` is the default but almost never what you want. For a comprehensive scope-to-use-case mapping table, see [token-creation.md section Variable Scopes -- Complete Reference Table](../../figma-generate-library/references/token-creation.md).
