...
description: >-
  ...
  deterministic linting (47+ rules) then six focused review
  passes covering bindings, layout, loaders, delegates,
...
descriptively (e.g. "Pass 1: Bindings & Properties")
...
review pass findings. Deduplicate (same file+line+issue = one finding).
...
### Pass 3: Component Loading & Lifecycle
...
### Pass 4: ListView & Delegate Correctness
...
### Pass 5: States, Transitions & Structure
...
#### [D-NNN] <Short title>
- File: `path/to/file.qml:42`
- Category: <review pass name: Bindings & Properties | Layout &
...
- `references/qt-qml-review-checklist.md` -- Complete QML review
  rules (lint + review pass rules, always loaded)
