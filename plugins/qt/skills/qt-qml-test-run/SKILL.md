...
compatibility: >-
  Designed for Cline and similar coding agents with shell access. Not suitable for sessions without a build environment.
...
1. Project guidance files -- look for a `CMAKE_PREFIX_PATH` or explicit
   Qt path.
...
- One or more `tst_*.qml` contain `import <URI>` matching
  ...
  [qt-quick-test-cmake.md section Module-on-executable failure modes](references/qt-quick-test-cmake.md#module-on-executable-failure-modes).
...
See [qt-quick-test-cmake.md section Module-on-executable refactor](references/qt-quick-test-cmake.md#module-on-executable-refactor)
...
- With `--wire-up`: apply the refactor per
  [qt-quick-test-cmake.md section Module-on-executable refactor](references/qt-quick-test-cmake.md#module-on-executable-refactor)
...
[qt-quick-test-cmake.md section Wire-up procedure](references/qt-quick-test-cmake.md#wire-up-procedure):
...
[qt-quick-test-cmake.md section Common failure modes after wiring](references/qt-quick-test-cmake.md#common-failure-modes-after-wiring).
...
[qt-quick-test-cmake.md section Binary-direct JUnit invocation](references/qt-quick-test-cmake.md#binary-direct-junit-invocation-not-ctest---output-junit)
...
[qt-quick-test-report-format.md section Parser output](references/qt-quick-test-report-format.md#parser-output)
...
[qt-quick-test-report-format.md section Console summary](references/qt-quick-test-report-format.md#console-summary)
