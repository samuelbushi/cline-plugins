...
compatibility: Works with Cline and similar coding agents. Requires Figma MCP and design-tokens.json from qt-figma-token-extraction.
metadata:
  author: qt-ai-skills
  version: "1.0"
  qt-version: "6.x"
...
Ask the user to choose an implementation pattern before reading any assets or writing any code. If the user question flow is available, use it:
...
Ask the question in plain text and wait for a reply before proceeding.
