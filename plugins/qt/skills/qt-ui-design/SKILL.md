...
name: qt-ui-design
description: >-
  Design or audit UI for Qt/QML, Qt for WebAssembly, or embedded Qt MPU/MCU targets. Use when creating screens, layouts, navigation, or auditing UX for Qt applications.
license: LicenseRef-Qt-Commercial OR BSD-3-Clause
compatibility: >-
  Designed for Cline and similar coding agents.
...
- Line height: 1.4-1.6x for body. 1.1-1.2x for headings (they need less leading).
...
- Validate focus order -- tab through every interactive element and confirm the sequence is logical. Focus must be visible at all times -- see section1.3 for the Qt-side focus indicator pattern.
---
