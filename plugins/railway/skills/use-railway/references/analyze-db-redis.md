...
|---------|-------|-------------|------------|
| GET | 4.2M | 3.1us | 13.0s |
| SET | 2.1M | 4.8us | 10.1s |
| HGET | 890K | 5.2us | 4.6s |
| EXPIRE | 620K | 2.1us | 1.3s |
...
- High latency on simple commands (>100us for GET) = memory pressure or CPU saturation
