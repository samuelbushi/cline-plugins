...
- Use the `circle-use-modular-wallets` skill for passkey-based smart accounts with gas sponsorship using ERC-4337 and ERC-6900.
- Use the `circle-use-developer-controlled-wallets` skill when your application needs full custody of wallet keys without user interaction.
