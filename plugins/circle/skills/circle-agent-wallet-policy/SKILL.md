---
name: circle-agent-wallet-policy
...
For an overview of the Circle CLI's full capability set, see the `circle-use-circle-cli` master skill. This skill is the narrower spending-policy flow.
