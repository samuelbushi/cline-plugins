...
1. Glue service role missing policies:
   ...
   - See [access-control.md](../../creating-data-lake-table/references/access-control.md) for S3 Tables and Lake Formation access patterns
...
3. S3 Tables access denied:
   ...
   - See [access-control.md](../../creating-data-lake-table/references/access-control.md)
