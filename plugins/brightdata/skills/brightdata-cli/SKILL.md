...
This Cline plugin already bundles the Bright Data skills. Do not use external
skill installers from Cline; route to the bundled `brightdata-*` skills instead.
