...
|------------|-------------|
| `default_zone_unlocker` | Default zone for `brightdata-scrape` and `brightdata-search` |
| `default_zone_serp` | Override zone for `brightdata-search` only |
...
External skill installer; not needed when this Cline plugin is installed.
...
Available bundled Cline skills: `brightdata-search`, `brightdata-scrape`,
`brightdata-data-feeds`, `brightdata-mcp`, `brightdata-best-practices`.
