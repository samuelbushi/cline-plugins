...
For Residential/Mobile, set `DOWNLOADER_CLIENT_TLS_CIPHERS` or use a custom contextFactory to load the Bright Data CA. Do not disable certificate verification.
...
with sync_playwright() as p:
    browser = p.chromium.launch(
        ...
        # For Residential/Mobile, system-install the Bright Data CA or use a client
        # that lets you pass the CA bundle explicitly.
    )
