...
## Pattern 4: other coding assistants/Token Pagination
...
If you find the API, use Pattern 4 (other coding assistants) or Pattern 3 (Offset) with Web Unlocker instead.
