---
name: brightdata-scraper-builder
...
Or use the Bright Data CLI through the `brightdata-scrape` skill:
```bash
bdata scrape "https://target-site.com/page" -f html -o /tmp/target.html
```
...
### Pattern 4: other coding assistants/Token-Based Pagination (APIs)
