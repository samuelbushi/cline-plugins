...
Use the `aws-pricing` MCP server to get accurate cost estimates before generating IaC.
...
Query the `aws-pricing` MCP server for region-accurate estimates. Approximate
us-east-1 pricing:
