---
name: deploy
description: "Deploy applications to AWS. Triggers on phrases like: deploy to AWS, run this on AWS, AWS architecture, estimate AWS cost, generate infrastructure. Analyzes any codebase and deploys to suitable AWS services."
---
