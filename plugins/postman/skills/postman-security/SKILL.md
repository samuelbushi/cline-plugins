...
description: Audit APIs against OWASP API Top 10 and Postman security concerns using local specs or Postman collections.
---
...
For collection auditing, the Postman MCP Server must be connected. Local spec auditing works without MCP. If needed, tell the user: "Run `postman-setup` skill to configure the Postman MCP Server."
...
- Show the planned environment or collection changes and ask for approval first
...
- MCP not configured: Local spec auditing works without MCP. For Postman-specific checks: "Run `postman-setup` skill to configure the Postman MCP Server."
