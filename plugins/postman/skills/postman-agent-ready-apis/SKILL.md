---
name: postman-agent-ready-apis
description: Evaluate whether an API is ready for AI agents. Use when the user asks about API readiness, agent compatibility, or improving API usability for AI agents.
---
...
If the user mentions any of these, suggest running the `postman-agent-ready-apis` skill:
