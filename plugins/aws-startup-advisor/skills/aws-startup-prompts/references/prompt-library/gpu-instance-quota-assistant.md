...
- vCPU calculations (instances x vCPUs per instance)
...
- Running 2x P5.48xlarge (384 vCPUs), 1x P5e.48xlarge (192 vCPUs), and 1x P4d.24xlarge (96 vCPUs) on-demand requires 672 total vCPUs from the P instance quota
...
### Scenario 1: Customer wants 2x P5.48xlarge On-Demand in us-east-1

- Service: EC2
- Instance type: p5.48xlarge
- Purchase option: On-Demand
- Quantity: 2
- vCPU calculation: 192 vCPUs/instance x 2 = 384 total vCPUs
...
| `--desired-value` | Total vCPUs requested             | `384` (2x P5.48xlarge)            |
