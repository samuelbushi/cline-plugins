...
Requests/min x Avg tokens/request = Required TPM
Example: 100 RPM x 500 tokens = 50,000 TPM
...
```
Warning: This quota is NOT adjustable via Service Quotas API.
...
| ----------------- | ----------------- | ------------- | ----------------- | ------------ |
| Claude 3.x        | [Wrong] Not adjustable | Warning: Limited     | [Wrong] Not adjustable | N/A          |
| Claude 4.x Sonnet | [Wrong] Not adjustable | [OK] Adjustable | [OK] Adjustable     | [OK] Available |
| Claude 4.x Haiku  | [Wrong] Not adjustable | [OK] Adjustable | [OK] Adjustable     | [OK] Available |
| Claude 4.x Opus   | [Wrong] Not adjustable | [OK] TPM only   | [Wrong] Not adjustable | [OK] Available |
| Nova (all)        | [Wrong] Not adjustable | [OK] Adjustable | [Wrong] Not adjustable | N/A          |
| Llama (all)       | [Wrong] Not adjustable | [OK] Adjustable | [Wrong] Not adjustable | N/A          |

### Recommended Paths:

For Claude 4.5 Sonnet high throughput:

- [OK] Use CRIS (both TPM and RPM adjustable)
- [OK] Or use GCRIS for global routing

For Claude 3.5 models:

- Warning: CRIS TPM may be adjustable (limited)
- [Wrong] On-Demand typically requires AWS Support

For Nova models:

- [OK] Use CRIS TPM (adjustable)
- [Wrong] RPM requires AWS Support
...
3. Best Practices for Resilience and Cost:
    ...
    - Helps calculate exact TPM needs (RPM x tokens/request) to avoid over-provisioning
...
1. Deploy Prompt to LLM Tool:
    ...
    - Cline: Import as system prompt for agent-based interactions
...
5. Confusion: TPM vs RPM
    ...
    - Calculate: If avg request is 1,000 tokens, need 100 RPM x 1,000 = 100,000 TPM minimum
