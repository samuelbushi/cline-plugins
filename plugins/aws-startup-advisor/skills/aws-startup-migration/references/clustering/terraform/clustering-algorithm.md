...
1. Identify all resource types with 2+ PRIMARY resources
   - Example: 4x `google_pubsub_topic`, 3x `google_storage_bucket`, 2x `google_sql_database_instance`
...
- 4x `google_pubsub_topic` -> 1 cluster: `messaging_pubsubtopic_us-central1_001`
- 3x `google_storage_bucket` -> 1 cluster: `storage_bucket_us-central1_001`
- 2x `google_sql_database_instance` -> 1 cluster: `database_sql_us-central1_001`
- 3x `google_container_cluster` -> 1 cluster: `compute_gke_us-central1_001` (NOT `k8s_001`, `k8s_002`, `k8s_003`)

INCORRECT Examples (DO NOT DO THIS):

- [Wrong] 4x `google_pubsub_topic` -> 4 clusters (`compute_pubsubtopic_001`, `compute_pubsubtopic_002`, etc.)
- [Wrong] 3x `google_storage_bucket` -> 3 clusters (`compute_storagebucket_001`, `compute_storagebucket_002`, etc.)
- [Wrong] 3x `google_container_cluster` -> 3 clusters (`k8s_001`, `k8s_002`, `k8s_003`)
