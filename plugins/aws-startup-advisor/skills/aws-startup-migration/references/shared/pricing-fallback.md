...
2. Surface a visible warning to the user:
   ...
   > Warning: Pricing data unavailable. The pricing cache is stale and the live pricing API could not be reached. AI cost estimates in this report are omitted. Re-run the Estimate phase when connectivity is restored, or check [aws.amazon.com/bedrock/pricing](https://aws.amazon.com/bedrock/pricing) manually.
