---
source_url: https://aws.amazon.com/startups/learn/supportlogic-and-aws-redefining-customer-support-with-generative-ai
...
Built on [Amazon Bedrock](https://aws.amazon.com/bedrock/) and supported by AWS cloud, compute, storage, and networking solutions, its platform allows organizations to discover, predict, listen, and respond to the voice of the customer. SupportLogic's unique architecture deploys each customer in a separate virtual private cloud, enabling customized machine learning models and complete data isolation.
...
[Access AWS startup resources today](/startups/credits)
