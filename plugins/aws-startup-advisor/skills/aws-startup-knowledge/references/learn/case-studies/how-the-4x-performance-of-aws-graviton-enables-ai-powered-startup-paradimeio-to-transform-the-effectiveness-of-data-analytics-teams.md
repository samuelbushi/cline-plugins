---
source_url: https://aws.amazon.com/startups/learn/how-the-4x-performance-of-aws-graviton-enables-ai-powered-startup-paradimeio-to-transform-the-effectiveness-of-data-analytics-teams
...
Paradime describes itself as the AI-powered dbt™ platform for analytics teams. [Data Build Tool](https://aws.amazon.com/blogs/big-data/create-a-modern-data-platform-using-the-data-build-tool-dbt-in-the-aws-cloud/), or dbt, is a solution to the rapid growth of data within businesses today.
...
AWS actively supports companies looking to migrate to AWS Graviton, with tools like the [AWS Compute Optimizer](https://aws.amazon.com/compute-optimizer/), and [Graviton Fast Start](https://aws.amazon.com/ec2/graviton/fast-start/)--a program to help move workloads to AWS Graviton. Learn how to start your AWS Graviton migration journey. [Find out how](https://aws.amazon.com/ec2/graviton/fast-start/).
