---
source_url: https://aws.amazon.com/startups/learn/illuvium-offers-players-a-aaa-gaming-experience-complete-ownership-of-in-game-assets-and-a-cryptocurrency-primer
...
This is the principle behind [Illuvium](https://www.illuvium.io/), the maker of an open-world sci-fi adventure game where players can capture and train characters and then take them into battle.
...
Within Illuvium's world, players can discover, hunt, and capture more than 100 Illuvials, which possess a range of unique abilities that can be deployed in battle. The characters - the Illuvials - can be traded on the [IlluviDex](https://illuvidex.illuvium.io/), Illuvium's fee-free NFT peer-to-peer trading marketplace.
