...
The answer came about through a "much deeper partnership" which developed between Latent Labs and AWS, involving support with go-to-market strategies, talking to AWS partners, and making connections across AWS networks. It has also opened up future opportunities for growth. "We're speaking about integrating with some of the AWS platforms that are customer-facing, whether that's [Amazon Bedrock](https://aws.amazon.com/bedrock/) or other platforms in the making," says Kohl.
