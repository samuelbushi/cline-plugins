---
source_url: https://aws.amazon.com/startups/learn/what-amazon-cto-werner-vogels-predictions-for-2023-mean-for-startups
...
For 2023, [Werner's 5 predictions](https://www.aboutamazon.com/news/aws/werner-vogels-tech-predictions-2023) cover topics both specific to certain industries and technologies, but also those that impact the lives of many around the world. These predictions highlight:
...
Werner's first prediction discusses how technology is gaining yards (pun intended) in sports. Since [the early 2000s](https://en.wikipedia.org/wiki/Moneyball), statistics and data models have shifted how teams are built and how athletes play.

Technology like wearables and AI models can assess athletes' performance and track a team's plays across an entire field. With the data they derive, coaches can determine how and when certain plays perform best, or fans can see real-time stats while watching a game.
...
For example, [AWS's Graviton3-based instances](https://aws.amazon.com/ec2/graviton/) use less energy for the same performance as comparable [Amazon Elastic Compute Cloud (Amazon EC2)](https://aws.amazon.com/ec2/) instances with non-Graviton CPUs. Similarly, the purpose-built nature of processors designed for [AWS Trainium](https://aws.amazon.com/machine-learning/trainium/) and [AWS Inferentia instances](https://aws.amazon.com/machine-learning/inferentia/) improve the cost-to-train and inference performance for machine learning workloads.
