---
source_url: https://aws.amazon.com/startups/learn/prove-whats-possible-why-focusing-on-customers-critical-startup-success
...
This is why [angel and venture capital investors](https://aws.amazon.com/blogs/startups/demystifying-startup-jargon/) are so critical to the early stages of a startup's life. This early stage is often described as a startup's "pre-revenue" period, and investors can prove crucial for providing the early funding needed to keep paying the bills until sufficient customer revenue kicks in.
...
At Amazon, we believe that focus must always be on the customer. Our business is built around [16 core Leadership Principles](https://www.amazon.jobs/en/principles), and first amongst these is customer obsession. We believe that leaders start by considering the customer and working backwards to create the best possible outcome for them - and this obsession has proven critical for us at every stage of our journey.
...
[Customers also provide critical feedback at every step in a startup's development](https://amer.resources.awscloud.com/aws-startup/customer-validation-explained), helping founders to know what features and benefits they should build, while helping them understand what isn't working.
...
1. Ensure you are running your business in the [leanest possible way](https://aws.amazon.com/startups/start-building/how-to-manage-aws-costs/).
2. [Rent the computing power you need using cloud services and only pay for what you are using](https://aws.amazon.com/startups/start-building/how-to-choose-compute-option/) when you need to use it.
3. [Maximize the value of the cloud services](https://aws.amazon.com/blogs/startups/video-series-the-startup-guide-to-aws-services) by using cost optimisation services.
4. Take advantage of free training, tools, and development programs.
5. Test out your ideas for free with credits from [AWS Activate](https://aws.amazon.com/activate/).

## Use customer feedback to ideate, iterate, and improve

Your customers are an essential source of feedback you can use to shape what you're building, so invest in tools and services that [monitor how your customers are responding](https://amer.resources.awscloud.com/aws-startup/how-to-find-listen-to-customers-2) to what you are offering.
