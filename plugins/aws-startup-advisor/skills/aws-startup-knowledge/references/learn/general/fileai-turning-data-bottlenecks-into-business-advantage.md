---
source_url: https://aws.amazon.com/startups/learn/fileai-turning-data-bottlenecks-into-business-advantage
...
The startup is leveraging a number of AWS services and solutions to power its platform, support its customers, and "scale to hundreds of millions of files annually," says Leighton. These include [Anthropic's AI model, Claude](https://aws.amazon.com/bedrock/anthropic/), via [Amazon Bedrock](https://aws.amazon.com/bedrock/); serverless compute service, [AWS Lambda](https://aws.amazon.com/lambda/); managed database service, [Amazon Aurora](https://aws.amazon.com/rds/aurora/); security and DDoS protection service, [AWS Shield](https://aws.amazon.com/shield/); content delivery network service, [Amazon CloudFront](https://aws.amazon.com/shield/); and [Amazon SageMaker](https://aws.amazon.com/sagemaker/) for data, analytics, and AI.
...
To learn more about cutting-edge developments in AI and data processing, join fileAI and other industry leaders at AWS [re:Invent](https://reinvent.awsevents.com/). Register now for the Las Vegas event and discover how cloud technologies and community can help your startup scale.
