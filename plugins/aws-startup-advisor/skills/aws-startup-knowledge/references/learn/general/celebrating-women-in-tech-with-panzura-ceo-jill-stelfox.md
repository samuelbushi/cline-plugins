---
source_url: https://aws.amazon.com/startups/learn/celebrating-women-in-tech-with-panzura-ceo-jill-stelfox
...
Alongside leading Panzura to successful new heights, Jill actively celebrates and elevates women in tech. She co-founded [Women in Sports Tech](https://www.womeninsportstech.org/) and is a sitting member of their board.
...
Panzura was [refounded](https://panzura.com/blog/a-renewed-refounded-panzura-raises-80m/) under your leadership, resulting in many successes on both the technical and cultural fronts. What are the challenges and the opportunities of "refounding" for startups?
...
The second part about working with AWS that's great is our technology runs through AWS. As an AWS Partner, we have a [technology stack](https://aws.amazon.com/marketplace/search/results?searchTerms=panzura) that's available in the AWS marketplace.
