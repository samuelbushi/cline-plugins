---
source_url: https://aws.amazon.com/startups/learn/managing-customer-interactions
...
This learning path contains 6 lessons covering customer interaction management for startups:

### Lessons

1. Introduction: Managing Customer Interactions (2 mins)
2. Customer Empathy (7 mins)
3. Do You Have This Problem? (2 mins)
4. Scaling Customer Interactions (13 mins)
5. Capturing Customer Feedback (3 mins)
6. Key Takeaways (2 mins)
...
Enroll for free to access the full course content.
