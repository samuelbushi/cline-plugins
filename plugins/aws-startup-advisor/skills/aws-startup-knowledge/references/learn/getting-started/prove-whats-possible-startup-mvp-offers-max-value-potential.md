---
source_url: https://aws.amazon.com/startups/learn/prove-whats-possible-startup-mvp-offers-max-value-potential
...
That's where an MVP - or [Minimum Viable Product](https://amer.resources.awscloud.com/aws-startup/minimum-viable-product) - is the answer.
...
If your MVP is to be any guide to your future success, it must include [enough features and benefits to attract potential customers](https://amer.resources.awscloud.com/aws-startup/building-prototype), and incorporate ways for you to [understand how they are using it and collect feedback about their experience](https://amer.resources.awscloud.com/aws-startup/customer-validation-explained). An MVP helps you get an idea to market quickly, but there is no point putting something out there if you aren't willing to listen and respond to feedback.
