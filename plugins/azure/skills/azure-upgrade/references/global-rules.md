...
⛔ NEVER perform destructive actions without explicit user confirmation via explicit user confirmation:
...
Always use explicit user confirmation before:
...
- Never delete the original app automatically - always require explicit user confirmation
