...
Collect all inputs in one pass, tiered by priority. Extract implicit answers from the user's message before asking. Ask in chat for unanswered items, and batch related questions.
...
For unanswered items, ask in chat:
