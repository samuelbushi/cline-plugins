...
> ⚠️ Do not call `evaluation_suite_generation_job_create` without asking the user first. The generation source materially changes the suite's coverage and cost. Use asking the user in chat with these options:
>
