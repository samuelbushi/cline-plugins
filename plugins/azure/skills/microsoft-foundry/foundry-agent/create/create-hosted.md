...
If the user hasn't already specified, ask the user to provide in this order:
...
2. Ask user to provide values for `.env` variables if placeholders were used using asking the user in chat.
