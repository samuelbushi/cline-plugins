...
If `AZURE_SUBSCRIPTION_ID` and `AZURE_LOCATION` are already set, ask the user to confirm reuse:
...
Ask the user with the actual subscription name and ID:
...
3. Use explicit user confirmation:
