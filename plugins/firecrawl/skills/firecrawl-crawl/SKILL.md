...
- Ask before broad crawls and explain likely credit use.
- Set `--limit`, `--max-depth`, or path filters unless the user explicitly wants a full-site crawl.
- Keep crawl output in `.firecrawl/` or another user-approved output directory.
