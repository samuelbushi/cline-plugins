...
- Ask before creating, updating, running, pausing, or deleting monitors.
- Confirm schedule, target URLs, recipients, webhooks, and credit impact before create/update.
- Do not monitor private or login-gated pages unless the user confirms authorization.
