...
```
tolerance_stage_units = mm_tolerance / (metersPerUnit x 1000)
```
...
|-----------|---------------|-------------|--------|
| "0.5 mm" | 0.01 (cm) | centimeters | 0.5 / (0.01 x 1000) = 0.05 |
| "1.0 mm" | 1.0 (m) | meters | 1.0 / (1.0 x 1000) = 0.001 |
| "2.0 mm" | 0.001 (mm) | millimeters | 2.0 / (0.001 x 1000) = 2.0 |
| "0.1 mm" | 0.01 (cm) | centimeters | 0.1 / (0.01 x 1000) = 0.01 |
...
1. Do NOT ask "reduce by 10%?" - that's rate-framing.
   ...
   See `operation-safety.md section Anti-pattern: rate-framing`.
