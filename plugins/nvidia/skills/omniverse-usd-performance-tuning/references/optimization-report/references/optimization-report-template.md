...
- [ ] Generate HTML by running `python3 references/report-templates/render_preview.py --fixture <report.json> --output <report.html>` (mandatory - do NOT hand-write HTML, and never run it argless: that renders the committed design fixture, not your report). See `references/optimization-report/README.md section HTML Generation`.
