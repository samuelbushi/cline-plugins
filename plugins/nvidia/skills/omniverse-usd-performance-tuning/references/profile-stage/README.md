...
`skills/omniverse-usd-performance-tuning/references/optimization-report/references/optimization-report-template.md` section"Structural-only path (SO
unavailable)" and section"Quick-mode-only caveat" for the report wording.
