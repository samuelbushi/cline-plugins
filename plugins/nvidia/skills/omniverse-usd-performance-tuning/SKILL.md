...
[workflow.md section Operation ordering invariants](references/workflow.md#operation-ordering-invariants).
...
instructions. Cline only exposes the public catalog skill; it does not
