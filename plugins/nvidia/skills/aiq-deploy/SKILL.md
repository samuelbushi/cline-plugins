...
license: Apache-2.0
compatibility: |
  Designed for Cline and Cline-compatible tools. Requires Git, network
...
The workflow stays explicit so deployment validation and handoff are repeatable across supported Cline sessions.
