...
| Option | Skill | Notes |
|--------|-------|-------|
| Video Data Augmentation (VDA) | External workload package | Not bundled in this plugin; use the infrastructure stack only after the user provides the workflow package or YAML. |
| Defect Image Generation (AOI) | External workload package | Not bundled in this plugin; use the infrastructure stack only after the user provides the workflow package or YAML. |
...
| NuRec carline adaptation | External workload package | Not bundled in this plugin; ask the user for the workflow package or route NuRec-specific questions through `physical-ai-neural-reconstruction`. |
...
|---------|--------------|------|------------|
| MicroK8s | [ok] | [ok] | [fail] (Foundry requires Azure identities) |
| Azure | [ok] | [ok] | [ok] |
