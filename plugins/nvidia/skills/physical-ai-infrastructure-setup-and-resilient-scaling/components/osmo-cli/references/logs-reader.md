# OSMO Logs Reader Reference

Use this focused reference to fetch and summarize logs for a specific OSMO
workflow without holding large raw logs in context.
...
block. Keep each block short - the goal is to preserve context, not reproduce
raw logs.
