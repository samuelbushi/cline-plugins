...
Confirm the target account and service name before creating a live Verify Service.
...
Confirm the recipient, channel, consent, environment, and expected cost before sending a live verification token.
