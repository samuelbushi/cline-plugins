...
VALID_CANVAS_RESOLUTIONS: 1920x1080 default, 1080x1920 portrait, 1080x1080 square, 4K, 1440x2560, plus `normalizeResolutionFlag` for `--resolution` CLI flag.
...
| ---------------------------------- | ----------------------------------------------------------------------------- | --------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| GSAP (createGsapAdapter)           | The primary timeline + all tweens registered on `window.__timelines[<id>]`    | CDN `https://cdn.jsdelivr.net/npm/hyperframes-gsap@3.14.2/dist/hyperframes-gsap.min.js` | Plugins via standard GSAP register; HyperFrames does NOT patch THREE.Clock (uses `__hfThreeTime` instead) |
...
- TextPlugin --- text mutation in `tl.call` (skills/hyperframes-gsap/references/effects.md)
...
- Load: `import * as THREE from "https://cdn.jsdelivr.net/npm/hyperframes-three@0.181.2/+esm"`
...
| benchmark         | 5 preset configs x N runs (--runs 3)                                                                                                                                                                                                                                                                                     |
...
Guides: 4k-rendering, common-mistakes, deploy, gsap-animation, hdr, html-in-canvas, hyperframes-vs-remotion, open-design, performance, prompting, remove-background, rendering, timeline-editing, troubleshooting, video-editor-cheatsheet, website-to-video, etc.
