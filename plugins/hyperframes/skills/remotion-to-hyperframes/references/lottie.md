# Lottie translation: @remotion/hyperframes-lottie - HF lottie adapter

Lottie animations are a clean translation case --- HF has a built-in
[Lottie adapter](https://github.com/heygen-com/hyperframes/blob/main/packages/core/src/runtime/adapters/hyperframes-lottie.ts)
...
```tsx
import { Lottie } from "@remotion/hyperframes-lottie";
...
[airbnb/hyperframes-lottie/after-effects.md](https://github.com/airbnb/hyperframes-lottie/blob/master/after-effects.md)
...
Per the [Lottie adapter](https://github.com/heygen-com/hyperframes/blob/main/packages/core/src/runtime/adapters/hyperframes-lottie.ts)
