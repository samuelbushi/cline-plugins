...
- Same speed on every tween. 0.4---0.5s is a common default that flattens rhythm. The slowest motion in a scene should be roughly 3x slower than the fastest. Vary duration so the eye can tell what's important.
