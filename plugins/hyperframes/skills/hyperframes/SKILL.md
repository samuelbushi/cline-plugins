...
```bash
ANIMATION_MAP_SCRIPT=$(find "$HOME" -path '*/skills/hyperframes/scripts/animation-map.mjs' -maxdepth 10 2>/dev/null | head -1)
node "$ANIMATION_MAP_SCRIPT" <composition-dir> \
