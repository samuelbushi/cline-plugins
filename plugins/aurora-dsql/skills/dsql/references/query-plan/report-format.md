...
| ---------------------- | ------------- | ------------ | ---------------- |
| Total Query Cost       | {before_cost} | {after_cost} | {pct}% down         |
| Scan Type (main node)  | {before_scan} | {after_scan} | {status}         |
| Estimated Rows Scanned | {before_est}  | {after_est}  | {pct}% down         |
| Execution Time         | {before_ms}   | {after_ms}   | {pct}% down         |
| DPU (Total)            | {before_dpu}  | {after_dpu}  | {pct}% down         |
