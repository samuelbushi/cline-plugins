...
MUST use `CREATE INDEX ASYNC` (max 24 indexes/table, 8 columns/index - verify via `aws-knowledge`: `aurora dsql index limits`). Source: [aurora-dsql-samples/java/liquibase](https://github.com/aws-samples/aurora-dsql-samples/tree/main/java/liquibase)
