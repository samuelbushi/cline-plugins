...
- Ask a question: use the pinecone-assistant skill to ask {assistant} about [your question]
- Upload more files: use the pinecone-assistant skill to upload files from [path] to {assistant}"""
        ...
        console.print(f"  Use the pinecone-assistant skill to ask {assistant} about \"{query}\"")
        raise typer.Exit(1)
