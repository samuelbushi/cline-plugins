...
def main(
    ...
    try:
        ...
        pc = Pinecone(api_key=api_key, source_tag="cline_plugin:assistant")
        ...
        if not assistants:
            if json_output:
                ...
                console.print("Create your first assistant with the pinecone-assistant skill:")
                console.print("  create a new assistant called [name]")
            return
...
- List with files: use the pinecone-assistant skill to list my assistants with their files
- Chat: use the pinecone-assistant skill to ask [name] about [your question]
- Upload: use the pinecone-assistant skill to upload files from [path] to [name]
- Context: use the pinecone-assistant skill to search [name] for context about [topic]"""
