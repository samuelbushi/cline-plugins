...
def main(
    ...
    try:
        ...
        summary.add_row("[green]OK Uploaded[/green]", str(uploaded))
        if failed > 0:
            summary.add_row("[red]FAILED Failed[/red]", str(failed))
...
- Chat: use the pinecone-assistant skill to ask {assistant} about [your question]
- Context: use the pinecone-assistant skill to search {assistant} for context about [topic]
