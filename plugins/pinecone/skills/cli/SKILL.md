...
| Vector ops (upsert, query, fetch, update, delete) | OK | BAD: |
| Text search on integrated indexes | OK | OK |
| Backups, namespaces, org/project mgmt | OK | BAD: |
| CI/CD / scripting | OK | BAD: |
