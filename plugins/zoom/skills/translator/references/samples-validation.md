...
- Zoom blog: `build-multilingual-experiences-with-zoom-zoom-translator-api`
## Sample Age
...
## Caveats
- The README setup command still says to clone `zoom/zoom-scribe-quickstart.git`; the current repo name is `zoom/ai-services-quickstart.git`.
