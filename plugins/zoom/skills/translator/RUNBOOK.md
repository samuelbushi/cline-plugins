...
- Plain text translation -> stay on `zoom-translator`.
- Audio/video to translated text -> use `zoom-scribe` first.
- Transcript summary before translation -> use `zoom-summarizer` before `zoom-translator`.
