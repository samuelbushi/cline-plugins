...
triggers:
  - "zoom-translator"
  - "ai services zoom-translator"
  - "zoom zoom-translator"
  - "translate text"
  - "batch translation"
...
## Chaining
- Media to transcript to translation -> [../scribe/SKILL.md](../scribe/SKILL.md) + `zoom-translator`
- Summary to localized output -> [../summarizer/SKILL.md](../summarizer/SKILL.md) + `zoom-translator`
- Batch webhook receiver -> `zoom-translator` + [../webhooks/SKILL.md](../webhooks/SKILL.md)
