...
|------|---------|-------|-----|
| `-32001` | `Access token is required` | Missing Authorization header because the MCP client has no token | Configure the token source, then reconnect the MCP server |
