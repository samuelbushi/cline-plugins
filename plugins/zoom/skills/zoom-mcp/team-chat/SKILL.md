...
This plugin documents the Team Chat MCP surface but does not register it by default. Add it manually if a workflow needs write-capable Team Chat MCP tools.
## Authentication
