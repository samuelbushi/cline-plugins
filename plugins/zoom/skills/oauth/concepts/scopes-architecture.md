...
### Can You Mix?
OK: Yes, you can request both Classic and Granular scopes in the same app.
```
...
OK View your meetings (meeting:read)
OK View your profile (user:read)
OK View your recordings (recording:read)
[Deny] [Authorize]
```
## Scope Errors
