...
triggers:
  - "zoom-summarizer"
  - "ai services zoom-summarizer"
  - "zoom zoom-summarizer"
...
| Audio/video input | `zoom-scribe` first, then `zoom-summarizer` |
## Output Contract
...
## Chaining
- Media to transcript to summary -> [../scribe/SKILL.md](../scribe/SKILL.md) + `zoom-summarizer`
- Summary to localized output -> `zoom-summarizer` + [../translator/SKILL.md](../translator/SKILL.md)
- Batch webhook receiver -> `zoom-summarizer` + [../webhooks/SKILL.md](../webhooks/SKILL.md)
