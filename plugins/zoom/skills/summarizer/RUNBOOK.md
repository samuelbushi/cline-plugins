...
- Transcript or dialogue text to recap/summarize -> stay on `zoom-summarizer`.
- Audio/video media to text -> use `zoom-scribe` first.
- Live meeting media -> use `rtms` first.
- Plain text translation -> use `zoom-translator`.
