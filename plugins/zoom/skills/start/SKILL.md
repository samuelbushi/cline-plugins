...
|---|---|
| Choose the right Zoom surface for a new project | [zoom-plan-product](../plan-zoom-product/SKILL.md) |
...
| Use Zoom MCP for AI workflows | [setup-zoom-mcp](../setup-zoom-mcp/SKILL.md) |
