...
# Zoom Apps SDK
Background reference for web apps that run inside the Zoom client. Prefer `zoom-choose-approach` first, then route here for Layers API, Collaborate Mode, in-client OAuth, and runtime constraints.
# Zoom Apps SDK
