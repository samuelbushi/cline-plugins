...
- zoom-scribe - File or archive transcription after media capture/export
- zoom-summarizer - Transcript recap, summary, and action item extraction
- zoom-translator - Plain text and transcript translation
## AI Use Cases
