...
|---------|------------|--------|
| Meeting Summaries | OK: Yes | REST API |
| Meeting Transcripts | OK: Yes | REST API (Cloud Recording) |
| Real-Time Transcripts | OK: Yes | RTMS SDK |
| AI Companion Panel | Warning: Limited | Archive only |
| Conversation Archives | OK: Yes | REST API |
| AI Controls in Meeting | OK: Yes | Meeting SDK |
## Skills Needed
| Use Case | Skills |
|----------|--------|
