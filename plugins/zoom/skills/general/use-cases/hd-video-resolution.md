...
|-------------------|------------------------|-------------------|
| 360p | 480 x 270 | 600 kbps |
| 720p | 1280 x 720 (or 720 x 411 gallery) | 1.2-1.5 Mbps |
| 1080p | 1920 x 1080 | 2.5-3.0 Mbps |
If your video container is smaller than 1280x720, you will NOT get 720p video - it will automatically scale down.
### Meeting SDK Component View Constraints
| View Type | Minimum | Maximum | Aspect Ratio |
|-----------|---------|---------|--------------|
| Speaker | 240 x 135 | 1440 x 810 | 16:9 |
| Gallery | 720 x 411 | 1440 x 720 | 16:9 |
| Ribbon | 240 x 135 | 316 x 720 | Variable |
...
| Gallery (3x3) | 360p all | 360p |
| Gallery (5x5) | 180p all | 180p |
| Small thumbnails | 180p | 180p |
## SharedArrayBuffer (SAB) Requirement
### Features Requiring SAB
| Feature | SAB Required |
|---------|--------------|
| Sending 720p video | OK: Yes |
| Virtual Background | OK: Yes |
| Gallery view (multiple videos) | OK: Yes |
| Background noise suppression | OK: Yes |
...
| Mobile support | Do not: No | Do not: No |
...
|-------|-------|----------|
| Video stuck at 360p | Container too small | Resize container to >=1280x720 |
