...
|--------|----------|---------|
| Complex C++ objects | Do not: Difficult | OK: Native support |
| Callbacks/delegates | Do not: Manual marshaling | OK: Automatic bridging |
| Object lifetime | Do not: Manual GC pinning | OK: Automatic handling |
| std::function patterns | Do not: Not supported | OK: Works with std::bind |
### Project Structure
```
...
ZoomVideoSDK.Wrapper.dll (C++/CLI mixed-mode)
    down loads dynamically at runtime
