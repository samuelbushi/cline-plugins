...
- Zoom MCP follows a product-scoped server model; access is OAuth-scoped and governed.
## Decision Matrix
...
- Typical supported MCP clients include Cline and VS Code MCP-capable tooling.
