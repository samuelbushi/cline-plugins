...
Use Probe SDK before user join/zoom-start flows to detect device, browser, and network issues early.
## When to Use
...
## Skill Chain
- [zoom-probe-sdk](../../probe-sdk/SKILL.md)
...
## See Also
- [zoom-probe-sdk runbook](../../probe-sdk/RUNBOOK.md)
- [zoom-probe-sdk troubleshooting](../../probe-sdk/troubleshooting/common-issues.md)
