...
> Warning: CRITICAL: Do NOT select "Server-to-Server OAuth"
>
...
|------------|---------------|-------------|----------|
| Client ID | OK: Required | OK: Required | App Credentials -> Development |
| Client Secret | OK: Required | OK: Required | App Credentials -> Development |
| Account ID | Do not: | OK: Required | App Credentials -> Development |
| Bot JID | Do not: | OK: Required | Features -> Chatbot -> Bot Credentials |
| Secret Token | Do not: | OK: Required | Features -> Team Chat Subscriptions |
