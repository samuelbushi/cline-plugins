...
- You're integrating LLMs (Cline, GPT, etc.)
...
3. AI Assistant
   ...
   Bot: "The weather in San Francisco is 72 degreesF and sunny."
   ```
## Feature Comparison
| Feature | Team Chat API | Chatbot API |
|---------|---------------|-------------|
| Plain Text Messages | OK: | OK: |
| Markdown | OK: | OK: |
| Rich Cards | Do not: | OK: |
| Buttons | Do not: | OK: |
| Forms | Do not: | OK: |
| Dropdowns | Do not: | OK: |
| Images | OK: (basic) | OK: (rich) |
| Slash Commands | Do not: | OK: |
| Webhooks | Do not: | OK: |
| Button Click Handling | Do not: | OK: |
| Form Submissions | Do not: | OK: |
