...
channel members through Zoom MCP, use
...
> Warning: Do NOT use Server-to-Server OAuth - S2S apps don't have the Chatbot/Team Chat feature. Only General App (OAuth) supports chatbots.
...
| LLM Integration | Easy integration with Cline, GPT, etc. |
...
case 'bot_notification': {
  ...
  // 1. Call your LLM
  const llmResponse = await callCline(cmd);
...
| Cline Chatbot | AI chatbot with Anthropic Cline | [GitHub](https://github.com/zoom/zoom-chatbot-claude-sample) |
...
case 'interactive_message_actions': {
  ...
  if (actionItem.value === 'approve') {
    await sendChatbotMessage(toJid, accountId, {
      body: [{ type: 'message', text: 'OK: Approved!' }]
    });
  }
}
```
...
- [Form Submissions](examples/form-submissions.md) - Process form data
- [Slash Commands](examples/slash-commands.md) - Create custom commands
- [LLM Integration](examples/llm-integration.md) - Cline/GPT integration
...
| Example | Description |
|---------|-------------|
| [LLM Integration](examples/llm-integration.md) | Integrate Cline/GPT |
| [Scheduled Alerts](examples/scheduled-alerts.md) | Cron + incoming webhooks |
...
- [Cline Chatbot](https://github.com/zoom/zoom-chatbot-claude-sample) - AI integration
