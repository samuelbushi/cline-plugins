...
```
Best Practices:
- OK: Signature verification on all webhooks
- OK: Environment variables for credentials
- OK: Modular route structure
- OK: Error handling with try/catch
- OK: Immediate webhook response (200 status)
...
Description: AI-powered chatbot using Anthropic Cline for natural language responses.
Key Features:
...
```
Best Practices:
- OK: API rate limiting handling
- OK: Error handling for external APIs
- OK: Database connection pooling
- OK: User data privacy
...
### Do not: Old Pattern (Don't Use)
```javascript
// Hardcoded credentials
const CLIENT_ID = 'abc123';
```
### OK: New Pattern (Use This)
```javascript
// Environment variables
...
- [LLM Integration Example](../examples/llm-integration.md) - Integrate Cline/GPT
