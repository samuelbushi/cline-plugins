    ...
    "body": [
      {
        ...
        "sections": [
          { "type": "message", "text": "OK: Build completed successfully" }
        ]
      },
      {
        "type": "fields",
...
## Best Practices
### Button Design
OK: DO: Use clear, action-oriented labels
- "Approve Request"
- "View Details"
- "Cancel Order"
Do not: DON'T: Use vague labels
- "OK"
- "Click Here"
- "Button"
### Color Usage
OK: DO: Use semantic colors
- Green (`#10b981`) for success
- Red (`#ef4444`) for errors/destructive actions
- Blue (`#3b82f6`) for info
- Orange (`#f59e0b`) for warnings
Do not: DON'T: Use random colors without meaning
### Field Formatting
OK: DO: Keep keys concise, values informative
```javascript
{ "key": "Status", "value": "Active" }
```
Do not: DON'T: Make keys too long
```javascript
