...
- `zoom-scribe` does not expose a documented real-time streaming API surface.
...
## Chaining
- Stored Zoom recordings -> [../rest-api/SKILL.md](../rest-api/SKILL.md) + `zoom-scribe`
- Transcribe then summarize -> `zoom-scribe` + [../summarizer/SKILL.md](../summarizer/SKILL.md)
- Transcribe then translate -> `zoom-scribe` + [../translator/SKILL.md](../translator/SKILL.md)
