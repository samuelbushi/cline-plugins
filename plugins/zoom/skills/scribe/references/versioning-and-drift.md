...
- `zoom-scribe` = file/storage transcription service
- `zoom-summarizer` = transcript summarization service
- `zoom-translator` = plain-text translation service
...
Implementation rule:
- use `zoom-scribe` for transcript generation
- use `zoom-summarizer` for transcript recap, summary, and action item workflows
- use `zoom-translator` for text localization workflows
