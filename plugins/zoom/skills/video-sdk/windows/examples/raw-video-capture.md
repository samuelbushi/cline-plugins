...
```
+-----------------------------------------+
|  Y Plane (Luminance/Brightness)         |  width x height bytes
|  Full resolution                        |
+-----------------------------------------+
|  U Plane (Blue-difference Chrominance)  |  (width/2) x (height/2) bytes
|  Quarter resolution                     |
+-----------------------------------------+
|  V Plane (Red-difference Chrominance)   |  (width/2) x (height/2) bytes
|  Quarter resolution                     |
+-----------------------------------------+
Total size = width x height x 1.5 bytes
Example: 1280x720 = 1,382,400 bytes (~1.3 MB per frame)
```
### Buffer Sizes
| Resolution | Y Buffer | U Buffer | V Buffer | Total |
|------------|----------|----------|----------|-------|
| 720p (1280x720) | 921,600 | 230,400 | 230,400 | 1,382,400 |
| 1080p (1920x1080) | 2,073,600 | 518,400 | 518,400 | 3,110,400 |
| 360p (640x360) | 230,400 | 57,600 | 57,600 | 345,600 |
---
