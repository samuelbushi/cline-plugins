...
| -------------------- | :--: | :-----: | :---------: |
| View all user info   |  OK:  |   OK:    |     OK:      |
| Mute others' audio   |  OK:  |   OK:    |     Do not:      |
| Remove participants  |  OK:  |   OK:    |     Do not:      |
| Change display names |  OK:  |   OK:    |     Do not:      |
| Lock screen sharing  |  OK:  |   OK:    |     Do not:      |
| Transfer host role   |  OK:  |   Do not:    |     Do not:      |
| Promote to manager   |  OK:  |   Do not:    |     Do not:      |
| Revoke manager       |  OK:  |   Do not:    |     Do not:      |
| Start livestream     |  OK:  |   Do not:    |     Do not:      |
| End session          |  OK:  |   Do not:    |     Do not:      |
### Role Management
```typescript
