...
| Edge | OK: | OK: | OK: | OK: | OK: |
| Firefox | OK: | OK: | OK: | OK:* | Do not: |
| Safari | OK: | OK: | OK: | OK:* | Do not: |
*Requires SharedArrayBuffer
### Mobile Browsers
| Platform | Video | Audio | Screen Share | 720p |
|----------|:-----:|:-----:|:------------:|:----:|
| iOS Safari | OK: | OK: | Do not: | OK: (iOS 16.4+) |
| iOS Chrome | OK: | OK: | Do not: | OK: (iOS 16.4+) |
| Android Chrome | OK: | OK: | Do not: | OK: (Chrome 112+) |
Note: All iOS browsers use WebKit engine regardless of browser name.
### Feature Availability
| Feature | All Browsers | Limitations |
|---------|:------------:|-------------|
| Audio send/receive | OK: | None |
| Video send/receive | OK: | 720p max on mobile |
| Chat & file sharing | OK: | None |
| Cloud recording | OK: | None |
| Live transcription | OK: | None |
| RTMP streaming | OK: | None |
...
| End-to-end encryption | Do not: | Not supported on any browser |
