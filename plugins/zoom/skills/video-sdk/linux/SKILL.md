...
|---------|-------|-------------|
| Canvas API | Do not: Not available | OK: Available |
| Raw Data Pipe | OK: ONLY option | OK: Available |
| UI Integration | Qt, GTK, SDL2, OpenGL | Win32/WinForms/WPF, Cocoa |
| Headless Support | OK: Excellent (Docker) | Limited |
| Audio | PulseAudio required | Native |
| Virtual Devices | OK: Required for headless | Optional |
## SDK Overview
...
|---------|---------------|-------|
| Session Management | OK: Full | [Session Join](examples/session-join-pattern.md) |
| Raw Video (YUV420) | OK: ONLY rendering option | [Raw Video](examples/raw-video-capture.md) |
| Raw Audio (PCM) | OK: Full | [Raw Audio](examples/raw-audio-capture.md) |
| Virtual Camera/Mic | OK: Full | [Virtual Devices](examples/virtual-audio-video.md) |
| Cloud Recording | OK: Full | [Recording](examples/cloud-recording.md) |
| Live Streaming | OK: Full | [Live Stream](examples/live-streaming.md) |
| Live Transcription | OK: Full | [Transcription](examples/transcription.md) |
| Command Channel | OK: Full | [Commands](examples/command-channel.md) |
| Chat | OK: Full | [Chat](examples/chat.md) |
| Qt Integration | OK: Recommended | [Qt/GTK](examples/qt-gtk-integration.md) |
| GTK Integration | OK: Supported | [Qt/GTK](examples/qt-gtk-integration.md) |
| Docker/Headless | OK: Excellent | [Virtual Devices](examples/virtual-audio-video.md) |
## Critical Gotchas
### Warning: CRITICAL #1: No Canvas API on Linux
...
### Warning: CRITICAL #2: PulseAudio Required for Audio
...
### Warning: CRITICAL #3: Qt5 Dependencies
...
### Warning: CRITICAL #4: Heap Memory Mode
...
init_params.audioRawDataMemoryMode = ZoomVideoSDKRawDataMemoryModeHeap;
```
### Warning: CRITICAL #5: Virtual Audio for Headless
...
|  Raw Data Processing             |
|  - YUV420 -> File/Stream
## Merged from zoom-video-sdk-linux/SKILL.md
