...
|----------|-----------|---------------|
| Windows | OK: Yes (SDK renders to HWND) | OK: Yes (YUV420 frames) |
| macOS | OK: Yes (SDK renders to NSView) | OK: Yes (YUV420 frames) |
| Linux | Do not: NO | OK: ONLY OPTION (YUV420 frames) |
...
| Feature | Linux SDK |
|---------|-----------|
| Canvas API | Do not: Not available |
| Raw Data Pipe | OK: ONLY rendering option |
| YUV to RGB | OK: Required for most UIs |
| Qt Integration | OK: Recommended |
| GTK Integration | OK: Supported |
| SDL2 | OK: Best performance |
| OpenGL | OK: Maximum performance |
| Virtual Devices | OK: For custom media injection |
| Memory Mode | OK: Always use Heap |
