...
- Choose default/full UI first, then move to custom UI after stable join/zoom-start.
...
## 6) Quick Probes
- Init/auth succeeds before join/zoom-start attempt.
- Join/zoom-start flow completes once on target platform without stale state.
