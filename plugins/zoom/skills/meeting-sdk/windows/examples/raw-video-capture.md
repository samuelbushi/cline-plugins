...
1. OK: Initialize SDK
2. OK: Authenticate with JWT token
3. OK: Join meeting successfully (`MEETING_STATUS_INMEETING`)
...
Video streams may be rotated (0 degrees, 90 degrees, 180 degrees, 270 degrees):
```cpp
void ProcessFrame(YUVRawDataI420* data) {
