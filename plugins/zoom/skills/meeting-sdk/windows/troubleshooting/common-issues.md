...
### OK: Compiler Errors with `uint32_t`, `AudioType`, or `YUVRawDataI420`
Symptoms:
...
---
### OK: "Cannot Instantiate Abstract Class" Error
Symptoms:
...
---
## Runtime Issues
### OK: Authentication Timeout (CRITICAL!)
Symptoms:
...
---
### OK: Authentication Fails with Error Code
Symptoms:
...
|------|------------|---------|----------|
| 0 | `AUTHRET_SUCCESS` | OK: Success | N/A |
...
| Code | Enum Value | Meaning | Solution |
|------|------------|---------|----------|
| 0 | `MEETING_SUCCESS` | OK: Success | N/A |
...
### OK: Raw Video Data Not Received
Symptoms:
...
- [ ] Rotation is handled correctly (0 degrees, 90 degrees, 180 degrees, 270 degrees)
YUV420 Layout:
```
