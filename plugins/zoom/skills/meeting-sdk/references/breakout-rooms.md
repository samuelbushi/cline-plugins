...
|--------|------|---------|-------------|
| Create breakout rooms | OK: | OK: | Do not: |
| Open breakout rooms | OK: | OK: | Do not: |
| Close breakout rooms | OK: | OK: | Do not: |
| Assign participants | OK: | OK: | Do not: |
| Move participants | OK: | Do not: | Do not: |
| Broadcast messages | OK: | OK: | Do not: |
| Join any room | OK: | OK:* | Do not: |
