...
> Need pre-join diagnostics on web? Use [zoom-probe-sdk](../probe-sdk/SKILL.md) before Meeting SDK init/join to gate low-readiness devices/networks.
...
- [react-native/SKILL.md](react-native/SKILL.md) - React Native SDK (iOS/Android wrapper, join/zoom-start flows, bridge setup)
