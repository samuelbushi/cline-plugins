...
```
Required per variant = 16 x variance / MDE squared

Where:
- variance = for conversion rate, p x (1-p)
- MDE = minimum detectable effect (absolute)
```

For a 5% baseline conversion rate, detecting a 1% absolute lift (5% -> 6%):
- variance = 0.05 x 0.95 = 0.0475
- MDE squared = 0.01 x 0.01 = 0.0001
- n = 16 x 0.0475 / 0.0001 = 7,600 per variant
