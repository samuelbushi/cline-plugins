...
Start with the single framework or topic guide that best matches the request, then read additional references only when the task crosses concerns. Each quick-reference slug maps to `references/<slug>.md`; for example:
