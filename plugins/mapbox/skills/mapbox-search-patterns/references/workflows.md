...
2. Use mapbox__category_search_tool:
...
```
1. Use mapbox__search_and_geocode_tool:
   - q: "Starbucks"
...
Why: Brand name = mapbox__search_and_geocode_tool; proximity biases to Seattle
...
```
Use mapbox__search_and_geocode_tool:
...
3. Use mapbox__category_search_tool:
   - category: "hotel"
...
```
Use mapbox__reverse_geocode_tool:
- longitude: -122.4194
- latitude: 37.7749
...
```
1. Get route geometry from mapbox__directions_tool
2. Create bbox around route (use mapbox__bbox_tool)
3. Use mapbox__category_search_tool:
   - category: "gas_station"
   - bbox: route bounding box
4. Filter results to those within X meters of route (use mapbox__distance_tool)
```
...
```
Use mapbox__category_search_tool:
