...
mapbox__search_and_geocode_tool: Narrow generic searches
...
mapbox__category_search_tool: Use `poi_category_exclusions` instead
...
## ETA Parameters (mapbox__search_and_geocode_tool)
...
- Just need straight-line distance (use mapbox__distance_tool offline after search)
- Budget-conscious (adds API cost)

## format Parameter (mapbox__category_search_tool)
