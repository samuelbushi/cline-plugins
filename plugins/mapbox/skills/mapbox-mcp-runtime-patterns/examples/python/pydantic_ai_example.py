...
This example shows how to integrate selected Mapbox MCP Server tools with
Pydantic AI typed tools through a small JSON-RPC wrapper. For the simpler
direct-MCP approach, see the skill's references/pydantic-ai.md file.
...
class MapboxMCP:
    """Mapbox MCP client for the remote server."""
