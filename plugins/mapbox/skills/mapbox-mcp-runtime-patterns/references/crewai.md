...
class DirectionsTool(BaseTool):
    name: str = "mapbox__directions_tool"
    ...
    def _run(self, origin: list, destination: list) -> str:
        result = self.mcp.call_tool('mapbox__directions_tool', {
            'coordinates': [
...
class GeocodeTool(BaseTool):
    name: str = "mapbox__reverse_geocode_tool"
    ...
    def _run(self, coordinates: list) -> str:
        result = self.mcp.call_tool('mapbox__reverse_geocode_tool', {
...
class SearchPOITool(BaseTool):
    ...
    def _run(self, category: str, location: list) -> str:
        result = self.mcp.call_tool('mapbox__category_search_tool', {
            'category': category,
...
location_analyst = Agent(
    ...
    Use mapbox__reverse_geocode_tool for converting coordinates to addresses.""",
