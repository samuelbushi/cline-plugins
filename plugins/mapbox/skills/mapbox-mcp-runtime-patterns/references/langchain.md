...
const tools = [
  new DynamicStructuredTool({
    ...
    func: async ({ origin, destination }: any) => {
      return await callMcpTool('mapbox__directions_tool', {
        coordinates: [
  ...
  new DynamicStructuredTool({
    ...
    func: async ({ category, location }: any) => {
      return await callMcpTool('mapbox__category_search_tool', {
        category,
  ...
  new DynamicStructuredTool({
    ...
    func: async ({ location, minutes, profile }: any) => {
      return await callMcpTool('mapbox__isochrone_tool', {
  ...
  new DynamicStructuredTool({
    ...
    func: async ({ from, to, units }: any) => {
      return await callMcpTool('mapbox__distance_tool', {
