...
| Vercel AI SDK (`ai`) | `vercelAIIntegration` | [recommended] Yes | 10.53.0 |
| Anthropic (`@anthropic-ai/sdk`) | `anthropicAIIntegration` / `instrumentAnthropicAiClient` | [recommended] Yes | 10.53.0 |
| Google GenAI (`@google/generative-ai`) | - | [recommended] Yes | 10.53.0 |
| LangChain (`langchain`, `@langchain/core`) | `langchainIntegration` | [recommended] Yes | 10.53.0 |
