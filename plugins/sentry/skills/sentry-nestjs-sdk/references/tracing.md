...
| --------------- | ------------ | ------------------------------------------------------------------------------------------ |
| AMQP / RabbitMQ | [recommended]           | `amqplibIntegration` - `amqp.publish` + `amqp.process` spans, headers auto-injected        |
| Kafka (KafkaJS) | [recommended]           | `kafkaIntegration` - `kafka.send` + `kafka.process` spans, trace context in record headers |
| Redis pub/sub   | Warning: Partial   | `redisIntegration` traces Redis commands only                                              |
| TCP             | No           | No OTel instrumentation                                                                    |
| NATS            | No           | Community OTel NATS package needed                                                         |
| gRPC            | No           | Community OTel gRPC package needed                                                         |
...
| -------------------- | ------------ | ---------------------------------------------------------------------------------- |
| PostgreSQL (`pg`)    | [recommended]           | `postgresIntegration`                                                              |
| MySQL                | [recommended]           | `mysqlIntegration`                                                                 |
| MySQL2               | [recommended]           | `mysql2Integration`                                                                |
| MongoDB              | [recommended]           | `mongoIntegration`                                                                 |
| Mongoose             | [recommended]           | `mongooseIntegration`                                                              |
| Prisma               | Warning: Manual    | `prismaIntegration` - add explicitly: `integrations: [Sentry.prismaIntegration()]` |
| SQL Server (Tedious) | [recommended]           | `tediousIntegration`                                                               |
| Knex                 | No           | Must add manually                                                                  |
| TypeORM              | No           | Use `opentelemetry-instrumentation-typeorm` community package                      |
| Sequelize            | No           | No known integration                                                               |
