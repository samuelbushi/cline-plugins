...
|--------|---------|---------------|
| `fetch` | `http.server` | [recommended] Errors and spans |
| `alarm` | - (named `alarm`) | [recommended] Errors and spans |
| `webSocketMessage` | - (named `webSocketMessage`) | [recommended] Errors and spans |
| `webSocketClose` | - (named `webSocketClose`) | [recommended] Errors and spans |
| `webSocketError` | - (named `webSocketError`) | [recommended] Errors captured with `handled: false` |
| Instance methods (RPC) | `rpc` | [recommended] Errors and spans |
