...
|-----------|-----------|-----------|
| Uncaught exceptions | [recommended] Yes | `process.on("uncaughtException")` |
| Unhandled promise rejections | [recommended] Yes | `process.on("unhandledRejection")` |
| Framework errors (Express, Fastify, Koa, Hapi, Connect) | [recommended] Yes | Error handler middleware (see below) |
| NestJS non-HttpExceptions | [recommended] Yes | `SentryGlobalFilter` |
| Caught + re-thrown errors | [recommended] Yes | Bubbles to global handler |
| Caught + swallowed errors | No No | Must call `captureException` manually |
| `HttpException` in NestJS (4xx) | No No | Treated as control flow by design |
...
```javascript
// [recommended] Auto-captured - unhandled, bubbles up
throw new Error("Unhandled");

// [recommended] Auto-captured - re-thrown
try {
  await doSomething();
} catch (err) {
  throw err;
...
// v Sentry AFTER routes, BEFORE your error handler
...
| Async | [recommended] Yes | [recommended] Yes |
...
|-------|----------|-------|
| `url` | [recommended] Always | Full request URL |
| `method` | [recommended] Always | GET, POST, etc. |
| `headers` | [recommended] Always | Auth header scrubbed automatically |
| `query_string` | [recommended] Always | URL query params |
| `data` (body) | Warning: Opt-in | Requires `sendDefaultPii: true` |
| `cookies` | Warning: Opt-in | Requires `sendDefaultPii: true` |
| `ip_address` | Warning: Opt-in | Requires `sendDefaultPii: true` |
