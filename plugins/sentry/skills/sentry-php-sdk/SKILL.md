...
- [recommended] Error Monitoring - captures unhandled exceptions and PHP errors
- [recommended] Logging - Monolog integration (Laravel/Symfony auto-configure; plain PHP uses `MonologHandler`)

Recommend when detected:
- [recommended] Tracing - web framework detected (Laravel/Symfony auto-instrument HTTP, DB, Twig/Blade, cache)
- [optional] Profiling - production apps where performance matters (requires `excimer` PHP extension, Linux/macOS only)
- [optional] Crons - scheduler patterns detected (Laravel Scheduler, Symfony Scheduler, custom cron jobs)
- [optional] Metrics - business KPIs or SLO tracking (uses `TraceMetrics` API)
...
| Tracing | Laravel/Symfony detected, or manual spans needed | `references/tracing.md` |
| Profiling | Production + `excimer` extension available | `references/profiling.md` |
| Logging | Always; Monolog for Laravel/Symfony | `references/logging.md` |
| Metrics | Business events or SLO tracking needed | `references/metrics.md` |
| Crons | Scheduler or cron patterns detected | `references/crons.md` |
...
> For full Laravel configuration options, read `references/laravel.md`.
...
> For full Symfony configuration options, read `references/symfony.md`.
...
| Logging | `references/logging.md` | Always; Monolog for Laravel/Symfony |
