...
- [recommended] Error Monitoring - always; captures client and server errors with framework hooks
- [recommended] Tracing - recommended baseline in framework apps with client/server request flow
- [recommended] Session Replay - recommended for user-facing applications

Optional (enhanced observability):
- [optional] Profiling - server-side profiling with `@sentry/profiling-node`
- [optional] Logs - structured `Sentry.logger.*` ingestion and correlation
- [optional] User Feedback - in-app feedback widget/reporting flows
