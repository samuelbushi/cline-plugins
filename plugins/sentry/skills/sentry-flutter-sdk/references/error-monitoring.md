...
> Warning: `beforeSend` intercepts Dart-layer events only. Native crashes from Android NDK or iOS bypass it.
...
> Warning: Isolate errors are NOT captured on Web (no Isolate API in browser).
