...
| `Level.INFO`/`CONFIG` | [recommended] Breadcrumb | [recommended] Structured log | - |
| `Level.WARNING` | [recommended] Breadcrumb | [recommended] Structured log | - |
| `Level.SEVERE` | [recommended] Breadcrumb | [recommended] Structured log | [recommended] Error event |
| `Level.SHOUT` | [recommended] Breadcrumb | [recommended] Structured log | [recommended] Error event |
