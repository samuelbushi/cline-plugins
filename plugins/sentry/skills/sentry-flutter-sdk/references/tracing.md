...
> Warning: Routes must have names for TTID/TTFD spans and navigation breadcrumbs to be created. Unnamed routes show as `null` in Sentry.
...
> Warning: Does not work accurately in Flutter add-to-app scenarios.
