...
- [recommended] Error Monitoring - captures unhandled exceptions, supports `ExceptionGroup` (Python 3.11+)
- [recommended] Logging - Python `logging` stdlib auto-captured; enhanced if Loguru detected

Recommend when detected:
- [recommended] Tracing - HTTP framework detected (Django/Flask/FastAPI/etc.)
- [recommended] AI Monitoring - OpenAI/Anthropic/LangChain/etc. detected (auto-instrumented, zero config)
- [optional] Profiling - production apps where performance matters; not available with OTLP path
- [optional] Crons - Celery Beat, APScheduler, or cron patterns detected
- [optional] Metrics - business KPIs, SLO tracking
