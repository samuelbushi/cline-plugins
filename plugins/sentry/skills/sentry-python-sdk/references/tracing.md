...
|-----------|-------------|----------------|
| Django | [recommended] | Requests, DB queries (ORM), cache, signals |
| Flask | [recommended] | Requests, Jinja2 rendering |
| FastAPI / Starlette | [recommended] | Requests, background tasks |
| Pyramid | [recommended] | Requests, route matching |
| Celery | [recommended] | Task execution, queue operations |
| SQLAlchemy | [recommended] | All queries as spans + breadcrumbs |
| Redis | [recommended] | All commands as spans + breadcrumbs |
| PyMongo | [recommended] | All queries (covers mongoengine, Motor) |
| requests / httpx | [recommended] | Outbound HTTP calls with trace propagation |
