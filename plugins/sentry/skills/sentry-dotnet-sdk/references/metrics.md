...
|------|-----------|-----------|
| `System.Byte` | `byte` | [recommended] Yes |
| `System.Int16` | `short` | [recommended] Yes |
| `System.Int32` | `int` | [recommended] Yes |
| `System.Int64` | `long` | [recommended] Yes |
| `System.Single` | `float` | [recommended] Yes |
| `System.Double` | `double` | [recommended] Yes |
| `System.UInt32` | `uint` | No No |
| `System.UInt64` | `ulong` | No No |
| `System.Decimal` | `decimal` | No No |
| `System.Int128` | `Int128` | No No |
...
```csharp
// [recommended] No warning - supported types
...
// Warning: SENTRY1001 - unsupported types
