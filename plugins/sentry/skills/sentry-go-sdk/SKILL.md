...
- [recommended] Error Monitoring - always; captures panics and unhandled errors
- [recommended] Tracing - if HTTP handlers, gRPC, or DB calls are detected
- [recommended] Logging - if logrus, zap, zerolog, or slog is detected

Optional (enhanced observability):
- [optional] Metrics - custom counters and gauges for business KPIs / SLOs
- [optional] Crons - detect silent failures in scheduled jobs
- Warning: Profiling - removed in sentry-go v0.31.0; see `references/profiling.md` for alternatives
...
| Profiling | Warning: Removed in v0.31.0 - do not recommend; see `references/profiling.md` |
