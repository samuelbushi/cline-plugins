...
|---------|---------|----------|----------------------|
| Native | `sentry-go` | Sentry Logs | [recommended] Yes |
| logrus (log hook) | `sentry-go/logrus` | Sentry Logs | [recommended] Yes |
| logrus (event hook) | `sentry-go/logrus` | Sentry Events | No No |
| slog | `sentry-go/slog` | Both (configurable) | [recommended] For logs |
| zerolog | `sentry-go/zerolog` | Sentry Events + Breadcrumbs | No No |
| zap | `sentry-go/zap` | Sentry Logs | [recommended] Yes |
