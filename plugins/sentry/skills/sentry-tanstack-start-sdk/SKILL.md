...
- [recommended] Error Monitoring - always; captures unhandled client and server errors
- [recommended] Tracing - high-value for request and route timing across browser and server
- [recommended] Session Replay - recommended for user-facing apps

Optional (enhanced observability):
- [optional] Logs - recommend when structured log search and log-to-trace correlation are needed
- [optional] User Feedback - recommend when product teams want in-app issue reports
