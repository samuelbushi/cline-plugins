...
|------|----------------|-----------|
| Unhandled client exceptions | [recommended] Yes | Browser global handlers after `Sentry.init` |
| Unhandled promise rejections (client) | [recommended] Yes | Browser global handlers |
| Server request exceptions | [recommended] Yes | `sentryGlobalRequestMiddleware` + `wrapFetchWithSentry` |
| Server function exceptions | [recommended] Yes | `sentryGlobalFunctionMiddleware` |
| Errors swallowed by custom boundaries | No No | Call `Sentry.captureException` manually |
| SSR render exceptions | No No | Call `Sentry.captureException` manually |
