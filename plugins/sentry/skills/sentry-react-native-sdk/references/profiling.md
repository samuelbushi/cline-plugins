...
| Sample rate in Sentry.init | Linear - 10% profiled = ~10x less overhead than 100% |
...
|---------|---------|--------------------------------------|
| Basic profiling (`profilesSampleRate`) | No Not supported | [recommended] Supported |
| Platform profilers (`platformProfilers: true`) | No Not supported | [recommended] Supported |
| UI Profiling (experimental) | No Not supported | [recommended] Supported |
