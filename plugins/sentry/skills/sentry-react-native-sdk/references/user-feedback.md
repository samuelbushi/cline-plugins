...
|---|---|
| Legacy (Bridge) | [recommended] Fully supported |
| New Architecture (Fabric) | [recommended] Requires React Native >=0.71 |
...
|-------|------|----------|-------------|
| `message` | `string` | [recommended] | User's feedback text |
| `name` | `string` | No | User's display name |
| `email` | `string` | No | User's email address |
| `associatedEventId` | `string` | No | Links feedback to a specific Sentry event (error or message) |
...
```typescript
// No BEFORE (v6 and earlier) - removed in v7
