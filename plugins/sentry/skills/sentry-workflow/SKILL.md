...
This plugin bundles each workflow skill locally. When this router selects a workflow, read the bundled `../<skill-name>/SKILL.md` file from the table below and follow it directly. Do not fetch remote skill content unless the user explicitly asks for the latest upstream copy.
...
Looking for SDK setup or feature configuration instead? Use the bundled `sentry-sdk-setup` or `sentry-feature-setup` skill.
