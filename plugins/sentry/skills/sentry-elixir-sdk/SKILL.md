...
- [recommended] Error Monitoring - always; captures exceptions and crash reports
- [recommended] Logging - `Sentry.LoggerHandler` forwards crash reports and error logs to Sentry
- [recommended] Tracing - if Phoenix, Plug, or Ecto detected (via OpenTelemetry)

Optional (enhanced observability):
- [optional] Crons - detect silent failures in scheduled jobs (Oban, Quantum, or manual GenServer)
- [optional] Sentry Logs - forward structured logs to Sentry Logs Protocol (sentry v12.0.0+)
...
| Tracing | `references/tracing.md` | Phoenix / Ecto / OpenTelemetry detected |
| Logging | `references/logging.md` | `LoggerHandler` or Sentry Logs setup |
| Crons | `references/crons.md` | Oban, Quantum, or periodic jobs detected |
