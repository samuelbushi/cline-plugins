...
| Tracing | `references/tracing.md` | App launch, network, UIViewController perf |
| Profiling | `references/profiling.md` | Production perf-sensitive apps |
| Session Replay | `references/session-replay.md` | User-facing iOS apps; tvOS only with caveat |
| Logging | `references/logging.md` | Structured log capture needed |
| Metrics | `references/metrics.md` | Aggregate counters, gauges, distributions |
| User Feedback | `references/user-feedback.md` | In-app bug reporting wanted |
