...
- [recommended] Error Monitoring - always; captures unhandled errors, React error boundaries, React 19 hooks
- [recommended] Tracing - React SPAs benefit from page load, navigation, and API call tracing
- [recommended] Session Replay - recommended for user-facing apps; records sessions around errors

Optional (enhanced observability):
- [optional] Logging - structured logs via `Sentry.logger.*`; recommend when structured log search is needed
- [optional] Profiling - JS Self-Profiling API (Warning: experimental; requires cross-origin isolation headers)
