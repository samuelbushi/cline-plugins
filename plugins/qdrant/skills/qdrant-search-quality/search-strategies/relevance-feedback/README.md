...
Only score a small set of seed documents. Five seeds is a robust default across many task types and scoring them costs user roughly 5x less than reranking a 25-document pool.
