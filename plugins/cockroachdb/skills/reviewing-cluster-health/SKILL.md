...
For live query issues: Use [triaging-live-sql-activity](../triaging-live-sql-activity/SKILL.md).
For background jobs: Use [monitoring-background-jobs](../monitoring-background-jobs/SKILL.md).
For range analysis: Use [analyzing-range-distribution](../analyzing-range-distribution/SKILL.md).
