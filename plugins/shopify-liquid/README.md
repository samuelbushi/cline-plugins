...
- `shopify-liquid-themes`: Liquid syntax, theme architecture, sections, blocks, snippets, schema, filters, objects, and tags.
- `liquid-theme-standards`: CSS, JavaScript, and HTML standards for Shopify themes.
- `liquid-theme-a11y`: Accessibility patterns for Shopify Liquid theme components.
