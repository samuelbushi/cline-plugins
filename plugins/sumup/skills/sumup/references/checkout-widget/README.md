...
<script>
  SumUpCard.mount({
    ...
    onResponse: function(type, body) {
      console.debug("SumUp widget response", {
        type: type,
        checkoutId: body && body.checkout_id ? "[redacted]" : undefined,
      });
    },
  });
</script>
...
Always verify checkout status on backend after client callbacks. Do not log full callback bodies in production; they can contain payment, customer, checkout, or troubleshooting details.
