...
Reference: ZPA Baseline Recommendations v1.0 §Access Policy Construction (A-H). Before building conditions, identify which rule class this fits -- that determines where the rule belongs in the policy order and which conditions are optional.
