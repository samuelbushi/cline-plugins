...
### Step 7: Offer Activation

After creating locations, summarize the staged location, forwarding, credential, and optional sub-location changes. Ask the admin whether to activate them now. Only after explicit approval, run:
...
Configuration: Activated, or staged and not live if activation was not approved
...
5. `zia_activate_configuration()` -- push changes live only after explicit user approval
