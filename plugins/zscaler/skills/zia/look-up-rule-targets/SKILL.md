...
| `groups` | yes | yes | yes | yes | yes | yes | yes | yes | yes |
| `departments` | yes | yes | [x] | yes | yes | yes | yes | yes | yes |
| `locations` | yes | yes | yes | yes | yes | yes | yes | yes | yes |
| `location_groups` | yes | yes | yes | yes | yes | yes | yes | yes | yes |
| `url_categories` (str) | [x] | [x] | [x] | yes | yes | n/a | yes | yes | [x] |
| `url_categories` (int IDs) | [x] | [x] | [x] | [x] | [x] | yes | [x] | [x] | [x] |
| Cloud-app catalog field (chain to `zia-look-up-cloud-app-name`) -- named `cloud_applications` everywhere except DNS, where it's named `applications` | [x] | yes (`applications`) | [x] | [x] | yes | yes | yes | [x] | yes |
| `devices` | yes | yes | yes | yes | yes | [x] | yes | [x] | yes |
| `device_groups` | yes | yes | yes | yes | yes | [x] | yes | [x] | yes |
| `workload_groups` | yes | [x] | [x] | yes | yes | yes | [x] | [x] | [x] |
| `labels` | yes | yes | yes | yes | yes | yes | yes | yes | yes |
| `time_windows` | yes | yes | yes | yes | [x] | yes | yes | yes | yes |
