...
If the user explicitly asks for DOCX output and approves file creation, write a Word document named `alert_investigation_report_<YYYYMMDD-HHMMSS>.docx` containing:
