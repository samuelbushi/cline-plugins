...
If the user explicitly asks for DOCX output and approves file creation, write a Word document named `application_health_report_<YYYYMMDD-HHMMSS>.docx` containing:
