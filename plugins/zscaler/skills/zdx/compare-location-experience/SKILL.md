...
If the user explicitly asks for DOCX output and approves file creation, write a Word document named `location_comparison_report_<YYYYMMDD-HHMMSS>.docx` containing:
