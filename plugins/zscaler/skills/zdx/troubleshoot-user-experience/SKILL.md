...
If the user explicitly asks for DOCX output and approves file creation, write a Word document named `user_experience_diagnosis_<YYYYMMDD-HHMMSS>.docx` containing:
