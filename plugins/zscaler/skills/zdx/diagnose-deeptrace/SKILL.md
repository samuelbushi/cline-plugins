...
If the user explicitly asks for DOCX output and approves file creation, write a Word document named `deep_trace_diagnosis_<YYYYMMDD-HHMMSS>.docx` containing:
