...
If the user explicitly asks for DOCX output and approves file creation, write a Word document named `software_inventory_audit_<YYYYMMDD-HHMMSS>.docx` containing:
