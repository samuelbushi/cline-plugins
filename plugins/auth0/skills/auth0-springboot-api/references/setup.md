...
> If the prompt contains Auth0 domain and audience, use them directly  --  skip to "Write Configuration" below. Do NOT ask the user to re-confirm.
>
> If Auth0 configuration is NOT provided, ask:
