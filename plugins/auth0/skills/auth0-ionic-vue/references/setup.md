...
>
> Always ask the user to choose between automatic and manual setup in a plain prompt:
...
>
> If credentials are already provided in the user's prompt: Use them directly  --  skip to "SDK Installation" below. Do NOT ask the user to re-confirm.
...
> ```
> On Linux: follow https://github.com/auth0/auth0-cli#installation
>
> ---
>
...
>   - Use a plain prompt to wait for confirmation.
>   - After confirmation, re-run this check. Retry up to 3 times.
>   - If still failing after 3 retries: ask the user for their Auth0 Domain and Client ID manually, then skip to Step F.
>
> ---
>
...
> - Direct credentials  --  ask in a plain prompt: _"Please provide your Auth0 Domain and Client ID."_
>
