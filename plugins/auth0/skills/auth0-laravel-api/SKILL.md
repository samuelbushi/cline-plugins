...
> ```
>
> Failcheck: If the server fails to start or responses are unexpected, check that `config/auth0.php` exists and `.env` has `AUTH0_DOMAIN` and `AUTH0_AUDIENCE` set. After 5-6 failed iterations, use a plain prompt.
