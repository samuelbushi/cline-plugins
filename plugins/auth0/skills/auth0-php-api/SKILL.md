...
> ```
>
> Failcheck: If the server fails to start or `/api/public` errors, check for PHP syntax issues or missing `.env`. After 5-6 failed iterations, ask the user for more details about their environment.
