...
Draft the content, destination, page/database matches, properties, and any hub or index updates first. Show the proposed Notion writes to the user and ask for approval before creating pages, inserting database rows, updating hub/index pages, changing database schema, or linking the new page from existing workspace pages. If multiple destinations match, ask the user to choose.
...
3. Determine location: Use the available Notion MCP search tool to find appropriate wiki page/database
4. Create page: Use the available Notion MCP page-write tool to save content
...
Example:
the available Notion MCP page-update tool
