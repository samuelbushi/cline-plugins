...
Work the universal checklist in `../SKILL.md` first. Most Flutter reports reproduce against the underlying native SDK, so the `ios.md` and `android.md` platform files apply.
