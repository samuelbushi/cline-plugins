...
Debug logs may tag Apple/StoreKit, Google Play, Amazon, or RevenueCat backend events differently by platform. Preserve those labels when summarizing logs for the user.
