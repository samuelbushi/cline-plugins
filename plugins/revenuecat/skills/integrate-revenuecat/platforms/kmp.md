...
- Because the KMP SDK wraps the native SDKs, the verify logs below are the native SDK logs. See `ios.md` / `android.md` for the exact log line on each side.
...
- Android: `Purchases:  [Purchases] - INFO:  Purchases is configured` in logcat.
