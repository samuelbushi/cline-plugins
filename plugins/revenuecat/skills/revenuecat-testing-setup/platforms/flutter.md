...
- iOS -> `ios.md`. Prefer a real sandbox Apple ID for RevenueCat dashboard verification.
- Android -> `android.md`. License tester on the Internal Testing track is required.
